...
AgreementPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://www.taxmobileapp.com/apptemplate/agreement/96'
    }),
...
var AppointmentPage = (function () {
    function AppointmentPage(navCtrl, http, sanitizer) {
        ...
        var projects = this.http.get('https://www.taxmobileapp.com/account/project/appointment_url/96');
        projects
...
AppointmentPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://www.taxmobileapp.com/apptemplate/appointment/96'
    }),
...
var StaffPage = (function () {
    function StaffPage(navCtrl, http) {
        ...
        this.http = http;
        this.staff_items = [];
        var staff = this.http.get('https://www.taxmobileapp.com/account/project/appstaff/96');
        staff
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
StaffPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-staff',
        templateUrl: 'https://www.taxmobileapp.com/apptemplate/staff/96'
    }),
...
var ContactPage = (function () {
    function ContactPage(navCtrl, http, plt, iab) {
        ...
        var locations = this.http.get('https://www.taxmobileapp.com/account/project/applocations/96');
        locations
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
ContactPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://www.taxmobileapp.com/apptemplate/contact/96'
    }),
...
SendAdditionalFormsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://www.taxmobileapp.com/apptemplate/sendAdditionalForms/96'
    }),
...
var PhotosPage = (function () {
    ...
    PhotosPage.prototype.submitPhotos = function (img_name) {
        ...
        var options = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["d" /* RequestOptions */]({ headers: headers });
        //console.log(options);
        var p = this.http.post('https://www.taxmobileapp.com/account/project/submitreturnimages', { imgData: this.uploadbase64Image, img_name: img_name, user_id: this.user_id, project_id: 96 }, options)
            .toPromise()
            .then(function (data) {
            //this.presentSuccess();
            //alert(data);
...
PhotosPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://www.taxmobileapp.com/apptemplate/photos/96'
    }),
...
var CompanyPage = (function () {
    function CompanyPage(navCtrl, http) {
        this.navCtrl = navCtrl;
        this.http = http;
        var projects = this.http.get('https://www.taxmobileapp.com/account/project/company_url/96');
        projects
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
var TwitterPage = (function () {
    function TwitterPage(navCtrl, http) {
        this.navCtrl = navCtrl;
        this.http = http;
        var projects = this.http.get('https://www.taxmobileapp.com/account/project/twitter_url/96');
        projects
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
var FacebookPage = (function () {
    function FacebookPage(navCtrl, http) {
        this.navCtrl = navCtrl;
        this.http = http;
        var projects = this.http.get('https://www.taxmobileapp.com/account/project/facebook_url/96');
        projects
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
var MyApp = MyApp_1 = (function () {
    ...
    MyApp.prototype.openShare = function () { this.socialSharing.share('First Tax Software, LLC', 'First Tax Software, LLC', 'https://www.taxmobileapp.com/images/projects/96-icon.png', 'https://www.taxmobileapp.com/share/96'); };
...
MyApp = MyApp_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        templateUrl: 'https://www.taxmobileapp.com/apptemplate/app/96'
    }),
...
HomePage = HomePage_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-home',
        templateUrl: 'https://www.taxmobileapp.com/apptemplate/home/96'
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
