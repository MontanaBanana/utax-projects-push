...
var ReturnPage = (function () {
    ...
    ReturnPage.prototype.submitPhotos = function () {
        ...
        var p = this.http.post('https://taxmobileapp.com/zxing-commandline/barcode.php', { imgData: this.uploadbase64Image, project_id: 285 }, options)
...
ReturnPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://taxmobileapp.com/apptemplate/return/285'
    }),
...
AgreementPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://taxmobileapp.com/apptemplate/agreement/285'
    }),
...
var AppointmentPage = (function () {
    function AppointmentPage(navCtrl, http, sanitizer) {
        ...
        var projects = this.http.get('https://taxmobileapp.com/account/project/appointment_url/285');
        projects
...
AppointmentPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://taxmobileapp.com/apptemplate/appointment/285'
    }),
...
var StaffPage = (function () {
    function StaffPage(navCtrl, http) {
        ...
        this.http = http;
        this.staff_items = [];
        var staff = this.http.get('https://taxmobileapp.com/account/project/appstaff/285');
        staff
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
StaffPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-staff',
        templateUrl: 'https://taxmobileapp.com/apptemplate/staff/285'
    }),
...
var ContactPage = (function () {
    function ContactPage(navCtrl, http, plt, iab) {
        ...
        var locations = this.http.get('https://taxmobileapp.com/account/project/applocations/285');
        locations
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
ContactPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://taxmobileapp.com/apptemplate/contact/285'
    }),
...
SendAdditionalFormsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://taxmobileapp.com/apptemplate/sendAdditionalForms/285'
    }),
...
var PhotosPage = (function () {
    ...
    PhotosPage.prototype.takePicture = function (img_name) {
        ...
        if (this.plt.is('ios')) {
            this.camera.getPicture({
                ...
                if (img_name == 'w2') {
                    if (typeof (_this.w2base64Image8) == 'string') {
                        _this.w2base64Image9 = imageData;
                    }
                    else if (typeof (_this.w2base64Image7) == 'string') {
                        _this.w2base64Image8 = imageData;
                    }
                    else if (typeof (_this.w2base64Image6) == 'string') {
                        _this.w2base64Image7 = imageData;
                    }
                    else if (typeof (_this.w2base64Image5) == 'string') {
                        _this.w2base64Image6 = imageData;
                    }
                    else if (typeof (_this.w2base64Image4) == 'string') {
                        _this.w2base64Image5 = imageData;
                    }
                    else if (typeof (_this.w2base64Image3) == 'string') {
                        _this.w2base64Image2 = imageData;
                    }
                    else if (typeof (_this.w2base64Image2) == 'string') {
                        _this.w2base64Image3 = imageData;
                    }
                    else if (typeof (_this.w2base64Image) == 'string') {
                        _this.w2base64Image2 = imageData;
                    }
                    else {
                    ...
                    if (typeof (_this.ten99base64Image8) == 'string') {
                        _this.ten99base64Image9 = imageData;
                    }
                    else if (typeof (_this.ten99base64Image7) == 'string') {
                        _this.ten99base64Image8 = imageData;
                    }
                    else if (typeof (_this.ten99base64Image6) == 'string') {
                        _this.ten99base64Image7 = imageData;
                    }
                    else if (typeof (_this.ten99base64Image5) == 'string') {
                        _this.ten99base64Image6 = imageData;
                    }
                    else if (typeof (_this.ten99base64Image4) == 'string') {
                        _this.ten99base64Image5 = imageData;
                    }
                    else if (typeof (_this.ten99base64Image3) == 'string') {
                        _this.ten99base64Image2 = imageData;
                    }
                    else if (typeof (_this.ten99base64Image2) == 'string') {
                        _this.ten99base64Image3 = imageData;
                    }
                    else if (typeof (_this.ten99base64Image) == 'string') {
                        _this.ten99base64Image2 = imageData;
                    }
                    else {
                    ...
                    if (typeof (_this.sscbase64Image8) == 'string') {
                        _this.sscbase64Image9 = imageData;
                    }
                    else if (typeof (_this.sscbase64Image7) == 'string') {
                        _this.sscbase64Image8 = imageData;
                    }
                    else if (typeof (_this.sscbase64Image6) == 'string') {
                        _this.sscbase64Image7 = imageData;
                    }
                    else if (typeof (_this.sscbase64Image5) == 'string') {
                        _this.sscbase64Image6 = imageData;
                    }
                    else if (typeof (_this.sscbase64Image4) == 'string') {
                        _this.sscbase64Image5 = imageData;
                    }
                    else if (typeof (_this.sscbase64Image3) == 'string') {
                        _this.sscbase64Image2 = imageData;
                    }
                    else if (typeof (_this.sscbase64Image2) == 'string') {
                        _this.sscbase64Image3 = imageData;
                    }
                    else if (typeof (_this.sscbase64Image) == 'string') {
                        _this.sscbase64Image2 = imageData;
                    }
                    else {
                    ...
                    if (typeof (_this.licensebase64Image8) == 'string') {
                        _this.licensebase64Image9 = imageData;
                    }
                    else if (typeof (_this.licensebase64Image7) == 'string') {
                        _this.licensebase64Image8 = imageData;
                    }
                    else if (typeof (_this.licensebase64Image6) == 'string') {
                        _this.licensebase64Image7 = imageData;
                    }
                    else if (typeof (_this.licensebase64Image5) == 'string') {
                        _this.licensebase64Image6 = imageData;
                    }
                    else if (typeof (_this.licensebase64Image4) == 'string') {
                        _this.licensebase64Image5 = imageData;
                    }
                    else if (typeof (_this.licensebase64Image3) == 'string') {
                        _this.licensebase64Image2 = imageData;
                    }
                    else if (typeof (_this.licensebase64Image2) == 'string') {
                        _this.licensebase64Image3 = imageData;
                    }
                    else if (typeof (_this.licensebase64Image) == 'string') {
                        _this.licensebase64Image2 = imageData;
                    }
                    else {
                    ...
                    if (typeof (_this.miscbase64Image8) == 'string') {
                        _this.miscbase64Image9 = imageData;
                    }
                    else if (typeof (_this.miscbase64Image7) == 'string') {
                        _this.miscbase64Image8 = imageData;
                    }
                    else if (typeof (_this.miscbase64Image6) == 'string') {
                        _this.miscbase64Image7 = imageData;
                    }
                    else if (typeof (_this.miscbase64Image5) == 'string') {
                        _this.miscbase64Image6 = imageData;
                    }
                    else if (typeof (_this.miscbase64Image4) == 'string') {
                        _this.miscbase64Image5 = imageData;
                    }
                    else if (typeof (_this.miscbase64Image3) == 'string') {
                        _this.miscbase64Image2 = imageData;
                    }
                    else if (typeof (_this.miscbase64Image2) == 'string') {
                        _this.miscbase64Image3 = imageData;
                    }
                    else if (typeof (_this.miscbase64Image) == 'string') {
                        _this.miscbase64Image2 = imageData;
                    }
                    else {
            ...
            this.camera.getPicture({
                ...
                if (img_name == 'w2') {
                    if (typeof (_this.w2base64Image8) == 'string') {
                        _this.w2base64Image9 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.w2base64Image7) == 'string') {
                        _this.w2base64Image8 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.w2base64Image6) == 'string') {
                        _this.w2base64Image7 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.w2base64Image5) == 'string') {
                        _this.w2base64Image6 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.w2base64Image4) == 'string') {
                        _this.w2base64Image5 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.w2base64Image3) == 'string') {
                        _this.w2base64Image2 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.w2base64Image2) == 'string') {
                        _this.w2base64Image3 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.w2base64Image) == 'string') {
                        _this.w2base64Image2 = "data:image/jpeg;base64," + imageData;
                    }
                    ...
                    if (typeof (_this.ten99base64Image8) == 'string') {
                        _this.ten99base64Image9 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.ten99base64Image7) == 'string') {
                        _this.ten99base64Image8 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.ten99base64Image6) == 'string') {
                        _this.ten99base64Image7 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.ten99base64Image5) == 'string') {
                        _this.ten99base64Image6 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.ten99base64Image4) == 'string') {
                        _this.ten99base64Image5 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.ten99base64Image3) == 'string') {
                        _this.ten99base64Image2 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.ten99base64Image2) == 'string') {
                        _this.ten99base64Image3 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.ten99base64Image) == 'string') {
                        _this.ten99base64Image2 = "data:image/jpeg;base64," + imageData;
                    }
                    ...
                    if (typeof (_this.sscbase64Image8) == 'string') {
                        _this.sscbase64Image9 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.sscbase64Image7) == 'string') {
                        _this.sscbase64Image8 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.sscbase64Image6) == 'string') {
                        _this.sscbase64Image7 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.sscbase64Image5) == 'string') {
                        _this.sscbase64Image6 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.sscbase64Image4) == 'string') {
                        _this.sscbase64Image5 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.sscbase64Image3) == 'string') {
                        _this.sscbase64Image2 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.sscbase64Image2) == 'string') {
                        _this.sscbase64Image3 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.sscbase64Image) == 'string') {
                        _this.sscbase64Image2 = "data:image/jpeg;base64," + imageData;
                    }
                    ...
                    if (typeof (_this.licensebase64Image8) == 'string') {
                        _this.licensebase64Image9 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.licensebase64Image7) == 'string') {
                        _this.licensebase64Image8 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.licensebase64Image6) == 'string') {
                        _this.licensebase64Image7 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.licensebase64Image5) == 'string') {
                        _this.licensebase64Image6 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.licensebase64Image4) == 'string') {
                        _this.licensebase64Image5 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.licensebase64Image3) == 'string') {
                        _this.licensebase64Image2 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.licensebase64Image2) == 'string') {
                        _this.licensebase64Image3 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.licensebase64Image) == 'string') {
                        _this.licensebase64Image2 = "data:image/jpeg;base64," + imageData;
                    }
                    ...
                    if (typeof (_this.miscbase64Image8) == 'string') {
                        _this.miscbase64Image9 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.miscbase64Image7) == 'string') {
                        _this.miscbase64Image8 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.miscbase64Image6) == 'string') {
                        _this.miscbase64Image7 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.miscbase64Image5) == 'string') {
                        _this.miscbase64Image6 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.miscbase64Image4) == 'string') {
                        _this.miscbase64Image5 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.miscbase64Image3) == 'string') {
                        _this.miscbase64Image2 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.miscbase64Image2) == 'string') {
                        _this.miscbase64Image3 = "data:image/jpeg;base64," + imageData;
                    }
                    else if (typeof (_this.miscbase64Image) == 'string') {
                        _this.miscbase64Image2 = "data:image/jpeg;base64," + imageData;
                    }
    ...
    PhotosPage.prototype.submitPhotos = function (img_name) {
        ...
        var options = new __WEBPACK_IMPORTED_MODULE_2__angular_http__["d" /* RequestOptions */]({ headers: headers });
        //console.log(options);
        var p = this.http.post('https://taxmobileapp.com/account/project/submitreturnimages', { imgData: this.uploadbase64Image, img_name: img_name, user_id: this.user_id, project_id: 285 }, options)
            .toPromise()
            .then(function (data) {
            //this.presentSuccess();
            //alert(data);
...
PhotosPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        templateUrl: 'https://taxmobileapp.com/apptemplate/photos/285'
    }),
...
var CompanyPage = (function () {
    function CompanyPage(navCtrl, http) {
        this.navCtrl = navCtrl;
        this.http = http;
        var projects = this.http.get('https://taxmobileapp.com/account/project/company_url/285');
        projects
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
CompanyPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-company',template:/*ion-inline-start:"/var/www/vhosts/taxmobileapp.com/httpdocs/public/projects/285/utax-ionic-template/src/pages/company/company.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>{{"Company"|translate}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n    &nbsp;\n\n</ion-content>\n\n'/*ion-inline-end:"/var/www/vhosts/taxmobileapp.com/httpdocs/public/projects/285/utax-ionic-template/src/pages/company/company.html"*/
    }),
...
var TwitterPage = (function () {
    function TwitterPage(navCtrl, http) {
        this.navCtrl = navCtrl;
        this.http = http;
        var projects = this.http.get('https://taxmobileapp.com/account/project/twitter_url/285');
        projects
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
TwitterPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-twitter',template:/*ion-inline-start:"/var/www/vhosts/taxmobileapp.com/httpdocs/public/projects/285/utax-ionic-template/src/pages/twitter/twitter.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>{{"Twitter"|translate}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n    &nbsp;\n\n</ion-content>\n\n'/*ion-inline-end:"/var/www/vhosts/taxmobileapp.com/httpdocs/public/projects/285/utax-ionic-template/src/pages/twitter/twitter.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* Http */]])
], TwitterPage);
...
var FacebookPage = (function () {
    function FacebookPage(navCtrl, http) {
        this.navCtrl = navCtrl;
        this.http = http;
        var projects = this.http.get('https://taxmobileapp.com/account/project/facebook_url/285');
        projects
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
...
FacebookPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-facebook',template:/*ion-inline-start:"/var/www/vhosts/taxmobileapp.com/httpdocs/public/projects/285/utax-ionic-template/src/pages/facebook/facebook.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>{{"Facebook"|translate}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n    &nbsp;\n\n</ion-content>\n\n'/*ion-inline-end:"/var/www/vhosts/taxmobileapp.com/httpdocs/public/projects/285/utax-ionic-template/src/pages/facebook/facebook.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* Http */]])
], FacebookPage);
...
var MyApp = MyApp_1 = (function () {
    ...
    MyApp.prototype.openShare = function () { this.socialSharing.share('RDL Enterprises 1 Stop Office Shop', 'RDL Enterprises 1 Stop Office Shop', 'https://taxmobileapp.com/images/projects/285-icon.png', 'https://taxmobileapp.com/share/285'); };
...
MyApp = MyApp_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        templateUrl: 'https://taxmobileapp.com/apptemplate/app/285'
    }),
...
HomePage = HomePage_1 = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-home',
        templateUrl: 'https://taxmobileapp.com/apptemplate/home/285'
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
