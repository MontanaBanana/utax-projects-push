...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('TJS & PA Tax Services', 'TJS & PA Tax Services', 'https://taxmobileapp.com/images/projects/407-icon.png', 'https://taxmobileapp.com/share/407'); }
