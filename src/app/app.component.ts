...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('M and M Tax Solutions', 'M and M Tax Solutions', 'https://www.taxmobileapp.com/images/projects/134-icon.png', 'https://www.taxmobileapp.com/share/134'); }
