...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Atlanta Tax Pro and Insurance, LLC', 'Atlanta Tax Pro and Insurance, LLC', 'https://www.taxmobileapp.com/images/projects/241-icon.png', 'https://www.taxmobileapp.com/share/241'); }
