...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Multiservicios Hispanos E&C', 'Multiservicios Hispanos E&C', 'https://taxmobileapp.com/images/projects/474-icon.png', 'https://taxmobileapp.com/share/474'); }
