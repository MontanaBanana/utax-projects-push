...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Detroit Tax Pros', 'Detroit Tax Pros', 'https://www.taxmobileapp.com/images/projects/223-icon.png', 'https://www.taxmobileapp.com/share/223'); }
