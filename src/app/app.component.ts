...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('K B Tax Service', 'K B Tax Service', 'https://taxmobileapp.com/images/projects/430-icon.png', 'https://taxmobileapp.com/share/430'); }
