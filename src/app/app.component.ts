...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Mitchell Tax Services', 'Mitchell Tax Services', 'https://www.taxmobileapp.com/images/projects/265-icon.png', 'https://www.taxmobileapp.com/share/265'); }
