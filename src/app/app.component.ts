...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Option 1 Tax', 'Option 1 Tax', 'https://www.taxmobileapp.com/images/projects/129-icon.png', 'https://www.taxmobileapp.com/share/129'); }
