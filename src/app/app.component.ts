...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('JRM Financial Group', 'JRM Financial Group', 'https://taxmobileapp.com/images/projects/531-icon.png', 'https://taxmobileapp.com/share/531'); }
