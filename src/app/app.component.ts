...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Overflow Tax & Financial Services', 'Overflow Tax & Financial Services', 'https://taxmobileapp.com/images/projects/369-icon.png', 'https://taxmobileapp.com/share/369'); }
