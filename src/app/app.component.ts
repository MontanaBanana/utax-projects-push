...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('BJ’s Tax Service', 'BJ’s Tax Service', 'https://taxmobileapp.com/images/projects/330-icon.png', 'https://taxmobileapp.com/share/330'); }
