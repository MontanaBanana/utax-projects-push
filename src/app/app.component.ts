...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Martinez Tax services', 'Martinez Tax services', 'https://taxmobileapp.com/images/projects/417-icon.png', 'https://taxmobileapp.com/share/417'); }
