...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('DeYaDa Enterprise LLC', 'DeYaDa Enterprise LLC', 'https://taxmobileapp.com/images/projects/189-icon.png', 'https://taxmobileapp.com/share/189'); }
