...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Northland tax consulting llc', 'Northland tax consulting llc', 'https://taxmobileapp.com/images/projects/503-icon.png', 'https://taxmobileapp.com/share/503'); }
