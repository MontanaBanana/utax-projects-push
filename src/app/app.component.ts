...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Remote Filing Services', 'Remote Filing Services', 'https://www.taxmobileapp.com/images/projects/242-icon.png', 'https://www.taxmobileapp.com/share/242'); }
