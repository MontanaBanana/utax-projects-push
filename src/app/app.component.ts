...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('1320 Tax Solutions', '1320 Tax Solutions', 'https://taxmobileapp.com/images/projects/338-icon.png', 'https://taxmobileapp.com/share/338'); }
