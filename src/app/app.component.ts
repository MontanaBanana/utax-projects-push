...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('MILLCO TAX CONSULTING SERVICES', 'MILLCO TAX CONSULTING SERVICES', 'https://www.taxmobileapp.com/images/projects/126-icon.png', 'https://www.taxmobileapp.com/share/126'); }
