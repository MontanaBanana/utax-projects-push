...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Annas Multiple Services', 'Annas Multiple Services', 'https://taxmobileapp.com/images/projects/306-icon.png', 'https://taxmobileapp.com/share/306'); }
