...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Family Affair Tax Pros', 'Family Affair Tax Pros', 'https://taxmobileapp.com/images/projects/274-icon.png', 'https://taxmobileapp.com/share/274'); }
