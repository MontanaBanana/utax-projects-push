...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('D.D. Bookkeeping & Notary Services', 'D.D. Bookkeeping & Notary Services', 'https://taxmobileapp.com/images/projects/492-icon.png', 'https://taxmobileapp.com/share/492'); }
