...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Del Valle Services', 'Del Valle Services', 'https://taxmobileapp.com/images/projects/469-icon.png', 'https://taxmobileapp.com/share/469'); }
