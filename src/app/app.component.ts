...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('KMV Tax Services', 'KMV Tax Services', 'https://taxmobileapp.com/images/projects/379-icon.png', 'https://taxmobileapp.com/share/379'); }
