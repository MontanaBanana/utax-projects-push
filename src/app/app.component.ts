...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('C. W. MORRIS TAX PREPARATION', 'C. W. MORRIS TAX PREPARATION', 'https://taxmobileapp.com/images/projects/357-icon.png', 'https://taxmobileapp.com/share/357'); }
