...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Sunshine Tax Service', 'Sunshine Tax Service', 'https://www.taxmobileapp.com/images/projects/268-icon.png', 'https://www.taxmobileapp.com/share/268'); }
