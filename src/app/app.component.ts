...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('LMW TAX & NOTARY SERVICES', 'LMW TAX & NOTARY SERVICES', 'https://taxmobileapp.com/images/projects/377-icon.png', 'https://taxmobileapp.com/share/377'); }
