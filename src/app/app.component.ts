...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Within Reach Solutions', 'Within Reach Solutions', 'https://taxmobileapp.com/images/projects/378-icon.png', 'https://taxmobileapp.com/share/378'); }
