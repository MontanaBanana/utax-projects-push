...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('LFS FINACIAL & INSURANCE', 'LFS FINACIAL & INSURANCE', 'https://taxmobileapp.com/images/projects/485-icon.png', 'https://taxmobileapp.com/share/485'); }
