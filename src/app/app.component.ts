...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Get You Right Tax Service', 'Get You Right Tax Service', 'https://taxmobileapp.com/images/projects/385-icon.png', 'https://taxmobileapp.com/share/385'); }
