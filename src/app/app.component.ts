...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('M&A Taxshield Software  Inc.', 'M&A Taxshield Software  Inc.', 'https://www.taxmobileapp.com/images/projects/66-icon.png', 'https://www.taxmobileapp.com/share/66'); }
