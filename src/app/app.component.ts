...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('A DREAM COME TRUE LLC', 'A DREAM COME TRUE LLC', 'https://taxmobileapp.com/images/projects/336-icon.png', 'https://taxmobileapp.com/share/336'); }
