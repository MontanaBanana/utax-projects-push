...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Premiere Financial Services of Western Palm Beach ', 'Premiere Financial Services of Western Palm Beach ', 'https://www.taxmobileapp.com/images/projects/207-icon.png', 'https://www.taxmobileapp.com/share/207'); }
