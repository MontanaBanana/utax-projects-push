...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Mayberry Tax and Loans', 'Mayberry Tax and Loans', 'https://taxmobileapp.com/images/projects/537-icon.png', 'https://taxmobileapp.com/share/537'); }
