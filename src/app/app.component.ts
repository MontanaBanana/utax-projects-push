...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Armida Blues Tax Company', 'Armida Blues Tax Company', 'https://taxmobileapp.com/images/projects/442-icon.png', 'https://taxmobileapp.com/share/442'); }
