...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Service Income Tax', 'Service Income Tax', 'https://taxmobileapp.com/images/projects/302-icon.png', 'https://taxmobileapp.com/share/302'); }
