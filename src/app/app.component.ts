...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Strategic Tax Pros LLC', 'Strategic Tax Pros LLC', 'https://taxmobileapp.com/images/projects/343-icon.png', 'https://taxmobileapp.com/share/343'); }
