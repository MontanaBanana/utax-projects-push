...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('L.B. LUXURY SERVICES', 'L.B. LUXURY SERVICES', 'https://taxmobileapp.com/images/projects/301-icon.png', 'https://taxmobileapp.com/share/301'); }
