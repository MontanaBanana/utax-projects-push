...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Jazzy Imports Tax Solutions', 'Jazzy Imports Tax Solutions', 'https://taxmobileapp.com/images/projects/314-icon.png', 'https://taxmobileapp.com/share/314'); }
