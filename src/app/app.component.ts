...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Pettett Tax Service', 'Pettett Tax Service', 'https://taxmobileapp.com/images/projects/497-icon.png', 'https://taxmobileapp.com/share/497'); }
