...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('ReddBird Tax Service', 'ReddBird Tax Service', 'https://taxmobileapp.com/images/projects/278-icon.png', 'https://taxmobileapp.com/share/278'); }
