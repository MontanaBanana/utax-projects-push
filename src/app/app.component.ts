...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('IV Rain Tax Pros', 'IV Rain Tax Pros', 'https://taxmobileapp.com/images/projects/350-icon.png', 'https://taxmobileapp.com/share/350'); }
