...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Medzam Consulting ', 'Medzam Consulting ', 'https://taxmobileapp.com/images/projects/480-icon.png', 'https://taxmobileapp.com/share/480'); }
