...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('CWB PROFESSIONAL TAX SERVICE', 'CWB PROFESSIONAL TAX SERVICE', 'https://taxmobileapp.com/images/projects/448-icon.png', 'https://taxmobileapp.com/share/448'); }
