...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Providence Financial Solutions', 'Providence Financial Solutions', 'https://taxmobileapp.com/images/projects/447-icon.png', 'https://taxmobileapp.com/share/447'); }
