...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('My Financial Strength', 'My Financial Strength', 'https://taxmobileapp.com/images/projects/312-icon.png', 'https://taxmobileapp.com/share/312'); }
