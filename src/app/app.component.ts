...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('The Income Tax House Corp', 'The Income Tax House Corp', 'https://taxmobileapp.com/images/projects/53-icon.png', 'https://taxmobileapp.com/share/53'); }
