...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Ryan’s Grand Refund', 'Ryan’s Grand Refund', 'https://taxmobileapp.com/images/projects/352-icon.png', 'https://taxmobileapp.com/share/352'); }
