...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Eclipse Tax Advisors', 'Eclipse Tax Advisors', 'https://taxmobileapp.com/images/projects/332-icon.png', 'https://taxmobileapp.com/share/332'); }
