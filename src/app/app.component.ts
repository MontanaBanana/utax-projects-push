...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('TRC Plantation Inc', 'TRC Plantation Inc', 'https://taxmobileapp.com/images/projects/246-icon.png', 'https://taxmobileapp.com/share/246'); }
