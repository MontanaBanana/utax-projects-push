...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Asher Business Group', 'Asher Business Group', 'https://taxmobileapp.com/images/projects/534-icon.png', 'https://taxmobileapp.com/share/534'); }
