...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Rightly Done Tax Services', 'Rightly Done Tax Services', 'https://taxmobileapp.com/images/projects/52-icon.png', 'https://taxmobileapp.com/share/52'); }
