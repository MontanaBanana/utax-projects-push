...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('INCOME TAX SERVICE', 'INCOME TAX SERVICE', 'https://taxmobileapp.com/images/projects/511-icon.png', 'https://taxmobileapp.com/share/511'); }
