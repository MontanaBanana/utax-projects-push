...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Loyal Tax and Designs', 'Loyal Tax and Designs', 'https://taxmobileapp.com/images/projects/521-icon.png', 'https://taxmobileapp.com/share/521'); }
