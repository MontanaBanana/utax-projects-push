...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('B’s Tax Service', 'B’s Tax Service', 'https://taxmobileapp.com/images/projects/128-icon.png', 'https://taxmobileapp.com/share/128'); }
