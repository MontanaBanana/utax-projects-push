...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('My Tax Lady Miami', 'My Tax Lady Miami', 'https://taxmobileapp.com/images/projects/296-icon.png', 'https://taxmobileapp.com/share/296'); }
