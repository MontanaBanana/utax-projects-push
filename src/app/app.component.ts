...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Matthew 25 Solutions', 'Matthew 25 Solutions', 'https://taxmobileapp.com/images/projects/529-icon.png', 'https://taxmobileapp.com/share/529'); }
