...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Elite Tax Professionals', 'Elite Tax Professionals', 'https://taxmobileapp.com/images/projects/233-icon.png', 'https://taxmobileapp.com/share/233'); }
