...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('BANG BANG TAX SERVICE', 'BANG BANG TAX SERVICE', 'https://taxmobileapp.com/images/projects/392-icon.png', 'https://taxmobileapp.com/share/392'); }
