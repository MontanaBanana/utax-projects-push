...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('LSC Tax Services', 'LSC Tax Services', 'https://taxmobileapp.com/images/projects/391-icon.png', 'https://taxmobileapp.com/share/391'); }
