...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Prestigious Tax Preparation Services', 'Prestigious Tax Preparation Services', 'https://taxmobileapp.com/images/projects/351-icon.png', 'https://taxmobileapp.com/share/351'); }
