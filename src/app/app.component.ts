...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Now Income Tax by Miguel Rodriguez', 'Now Income Tax by Miguel Rodriguez', 'https://taxmobileapp.com/images/projects/156-icon.png', 'https://taxmobileapp.com/share/156'); }
