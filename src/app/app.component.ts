...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('S & S Tax Service', 'S & S Tax Service', 'https://taxmobileapp.com/images/projects/234-icon.png', 'https://taxmobileapp.com/share/234'); }
