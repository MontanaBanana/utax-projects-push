...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Barron Enterprises Services', 'Barron Enterprises Services', 'https://taxmobileapp.com/images/projects/390-icon.png', 'https://taxmobileapp.com/share/390'); }
