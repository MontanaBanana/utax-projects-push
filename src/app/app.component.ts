...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('On Top Tax Services - Bayviews', 'On Top Tax Services - Bayviews', 'https://taxmobileapp.com/images/projects/200-icon.png', 'https://taxmobileapp.com/share/200'); }
