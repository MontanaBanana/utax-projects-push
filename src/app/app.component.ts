...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Roadside Tax Service', 'Roadside Tax Service', 'https://www.taxmobileapp.com/images/projects/240-icon.png', 'https://www.taxmobileapp.com/share/240'); }
