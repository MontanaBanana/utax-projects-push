...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('GYS TAX SERVICE', 'GYS TAX SERVICE', 'https://taxmobileapp.com/images/projects/288-icon.png', 'https://taxmobileapp.com/share/288'); }
