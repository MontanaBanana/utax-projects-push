...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('A List Tax Services', 'A List Tax Services', 'https://taxmobileapp.com/images/projects/347-icon.png', 'https://taxmobileapp.com/share/347'); }
