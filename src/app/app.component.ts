...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Furlow Bookkeeping and Tax Services', 'Furlow Bookkeeping and Tax Services', 'https://taxmobileapp.com/images/projects/459-icon.png', 'https://taxmobileapp.com/share/459'); }
