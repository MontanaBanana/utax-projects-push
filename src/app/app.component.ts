...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Mendez and Mendez ', 'Mendez and Mendez ', 'https://taxmobileapp.com/images/projects/67-icon.png', 'https://taxmobileapp.com/share/67'); }
