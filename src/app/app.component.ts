...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Tax Business Manager', 'Tax Business Manager', 'https://taxmobileapp.com/images/projects/88-icon.png', 'https://taxmobileapp.com/share/88'); }
