...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('AYB Solutions LLC', 'AYB Solutions LLC', 'https://taxmobileapp.com/images/projects/258-icon.png', 'https://taxmobileapp.com/share/258'); }
