...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('K-K TAXES & ACCOUNTING SERVICES', 'K-K TAXES & ACCOUNTING SERVICES', 'https://taxmobileapp.com/images/projects/539-icon.png', 'https://taxmobileapp.com/share/539'); }
