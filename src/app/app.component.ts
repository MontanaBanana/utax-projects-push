...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Pebble Creek Solutions by John Colver', 'Pebble Creek Solutions by John Colver', 'https://taxmobileapp.com/images/projects/124-icon.png', 'https://taxmobileapp.com/share/124'); }
