...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Sky Tax Partners', 'Sky Tax Partners', 'https://taxmobileapp.com/images/projects/494-icon.png', 'https://taxmobileapp.com/share/494'); }
