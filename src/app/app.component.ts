...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('World Multinational Corporations Consulting Group', 'World Multinational Corporations Consulting Group', 'https://taxmobileapp.com/images/projects/468-icon.png', 'https://taxmobileapp.com/share/468'); }
