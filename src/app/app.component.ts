...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('The One Resource', 'The One Resource', 'https://www.taxmobileapp.com/images/projects/173-icon.png', 'https://www.taxmobileapp.com/share/173'); }
