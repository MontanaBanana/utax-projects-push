...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Servicios Integrales', 'Servicios Integrales', 'https://www.taxmobileapp.com/images/projects/140-icon.png', 'https://www.taxmobileapp.com/share/140'); }
