...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Prosperous Financial Services', 'Prosperous Financial Services', 'https://taxmobileapp.com/images/projects/267-icon.png', 'https://taxmobileapp.com/share/267'); }
