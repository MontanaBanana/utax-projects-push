...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Stephanie’s Tax and Professional Services', 'Stephanie’s Tax and Professional Services', 'https://www.taxmobileapp.com/images/projects/55-icon.png', 'https://www.taxmobileapp.com/share/55'); }
