...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Multi-auto insurance services', 'Multi-auto insurance services', 'https://taxmobileapp.com/images/projects/389-icon.png', 'https://taxmobileapp.com/share/389'); }
