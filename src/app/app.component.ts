...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('SUNSHINE TAX SERVICE', 'SUNSHINE TAX SERVICE', 'https://taxmobileapp.com/images/projects/527-icon.png', 'https://taxmobileapp.com/share/527'); }
