...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Gataxza Enterprises, Inc.', 'Gataxza Enterprises, Inc.', 'https://www.taxmobileapp.com/images/projects/176-icon.png', 'https://www.taxmobileapp.com/share/176'); }
