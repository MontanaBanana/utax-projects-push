...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Earned Income Tax Solutions', 'Earned Income Tax Solutions', 'https://taxmobileapp.com/images/projects/244-icon.png', 'https://taxmobileapp.com/share/244'); }
