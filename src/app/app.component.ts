...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('TFS Financial Group ', 'TFS Financial Group ', 'https://taxmobileapp.com/images/projects/520-icon.png', 'https://taxmobileapp.com/share/520'); }
