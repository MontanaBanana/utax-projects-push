...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('FOSTER TAX SERVICES', 'FOSTER TAX SERVICES', 'https://taxmobileapp.com/images/projects/506-icon.png', 'https://taxmobileapp.com/share/506'); }
