...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Priority Pro Tax Prep', 'Priority Pro Tax Prep', 'https://taxmobileapp.com/images/projects/395-icon.png', 'https://taxmobileapp.com/share/395'); }
