...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('CPA TAX - Member Tax Service ', 'CPA TAX - Member Tax Service ', 'https://taxmobileapp.com/images/projects/70-icon.png', 'https://taxmobileapp.com/share/70'); }
