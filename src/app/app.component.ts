...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Maggie’s Travel & Tax Services', 'Maggie’s Travel & Tax Services', 'https://taxmobileapp.com/images/projects/316-icon.png', 'https://taxmobileapp.com/share/316'); }
