...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Community Services of Nevada', 'Community Services of Nevada', 'https://taxmobileapp.com/images/projects/519-icon.png', 'https://taxmobileapp.com/share/519'); }
