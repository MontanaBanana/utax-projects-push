...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Tyrone’s Tax Service, LLC', 'Tyrone’s Tax Service, LLC', 'https://www.taxmobileapp.com/images/projects/170-icon.png', 'https://www.taxmobileapp.com/share/170'); }
