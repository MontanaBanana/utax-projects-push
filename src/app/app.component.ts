...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Pebble Creek Solutions', 'Pebble Creek Solutions', 'https://www.taxmobileapp.com/images/projects/124-icon.png', 'https://www.taxmobileapp.com/share/124'); }
