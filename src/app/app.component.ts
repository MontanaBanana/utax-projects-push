...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('VIP TAX SOLUTIONS , LLC', 'VIP TAX SOLUTIONS , LLC', 'https://www.taxmobileapp.com/images/projects/178-icon.png', 'https://www.taxmobileapp.com/share/178'); }
