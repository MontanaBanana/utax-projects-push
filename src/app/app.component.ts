...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Y Solutions Taxes', 'Y Solutions Taxes', 'https://taxmobileapp.com/images/projects/145-icon.png', 'https://taxmobileapp.com/share/145'); }
