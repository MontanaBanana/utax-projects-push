...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Visions Tax Solutions and Services', 'Visions Tax Solutions and Services', 'https://taxmobileapp.com/images/projects/60-icon.png', 'https://taxmobileapp.com/share/60'); }
