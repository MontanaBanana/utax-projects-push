...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('SERVICIOS INTEGRALES - Free App', 'SERVICIOS INTEGRALES - Free App', 'https://taxmobileapp.com/images/projects/450-icon.png', 'https://taxmobileapp.com/share/450'); }
