...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('D and H Tax Service Inc', 'D and H Tax Service Inc', 'https://taxmobileapp.com/images/projects/137-icon.png', 'https://taxmobileapp.com/share/137'); }
