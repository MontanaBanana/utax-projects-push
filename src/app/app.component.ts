...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('SM Sweat Financial', 'SM Sweat Financial', 'https://www.taxmobileapp.com/images/projects/236-icon.png', 'https://www.taxmobileapp.com/share/236'); }
