...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('McDonald Tax Consulting', 'McDonald Tax Consulting', 'https://taxmobileapp.com/images/projects/325-icon.png', 'https://taxmobileapp.com/share/325'); }
