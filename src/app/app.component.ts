...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('CITI TAX SERVICE', 'CITI TAX SERVICE', 'https://taxmobileapp.com/images/projects/510-icon.png', 'https://taxmobileapp.com/share/510'); }
