...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Income Tax En tu Idioma', 'Income Tax En tu Idioma', 'https://taxmobileapp.com/images/projects/436-icon.png', 'https://taxmobileapp.com/share/436'); }
