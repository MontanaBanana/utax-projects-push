...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('JESS & JENN SERVICES CORP', 'JESS & JENN SERVICES CORP', 'https://taxmobileapp.com/images/projects/432-icon.png', 'https://taxmobileapp.com/share/432'); }
