...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Pro Tax Services', 'Pro Tax Services', 'https://taxmobileapp.com/images/projects/322-icon.png', 'https://taxmobileapp.com/share/322'); }
