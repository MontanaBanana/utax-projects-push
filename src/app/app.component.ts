...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('RDL Enterprises by Robert Lloyd', 'RDL Enterprises by Robert Lloyd', 'https://taxmobileapp.com/images/projects/285-icon.png', 'https://taxmobileapp.com/share/285'); }
