...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Global Tax Service', 'Global Tax Service', 'https://www.taxmobileapp.com/images/projects/80-icon.png', 'https://www.taxmobileapp.com/share/80'); }
