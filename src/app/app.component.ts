...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('QUALITY TAX & FINANCIAL SERVICES', 'QUALITY TAX & FINANCIAL SERVICES', 'https://taxmobileapp.com/images/projects/456-icon.png', 'https://taxmobileapp.com/share/456'); }
