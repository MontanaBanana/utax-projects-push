...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Express Tax & Financial Services', 'Express Tax & Financial Services', 'https://taxmobileapp.com/images/projects/365-icon.png', 'https://taxmobileapp.com/share/365'); }
