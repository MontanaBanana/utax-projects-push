...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Clemons Tax Services', 'Clemons Tax Services', 'https://taxmobileapp.com/images/projects/103-icon.png', 'https://taxmobileapp.com/share/103'); }
