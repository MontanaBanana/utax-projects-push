...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Olympic Star Financial', 'Olympic Star Financial', 'https://taxmobileapp.com/images/projects/62-icon.png', 'https://taxmobileapp.com/share/62'); }
