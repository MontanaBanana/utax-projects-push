...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Freedom tax Multi services', 'Freedom tax Multi services', 'https://taxmobileapp.com/images/projects/286-icon.png', 'https://taxmobileapp.com/share/286'); }
