...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Integrity Tax and More', 'Integrity Tax and More', 'https://www.taxmobileapp.com/images/projects/211-icon.png', 'https://www.taxmobileapp.com/share/211'); }
