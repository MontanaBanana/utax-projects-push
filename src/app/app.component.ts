...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Salazar Insurance and Financial Services', 'Salazar Insurance and Financial Services', 'https://taxmobileapp.com/images/projects/201-icon.png', 'https://taxmobileapp.com/share/201'); }
