...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('GandB Tax Service', 'GandB Tax Service', 'https://taxmobileapp.com/images/projects/42-icon.png', 'https://taxmobileapp.com/share/42'); }
