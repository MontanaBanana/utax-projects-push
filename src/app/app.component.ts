...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('El Rey Income Tax & Bookkeeping', 'El Rey Income Tax & Bookkeeping', 'https://taxmobileapp.com/images/projects/437-icon.png', 'https://taxmobileapp.com/share/437'); }
