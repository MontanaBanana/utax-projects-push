...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Trupoint Tax App', 'Trupoint Tax App', 'https://taxmobileapp.com/images/projects/282-icon.png', 'https://taxmobileapp.com/share/282'); }
