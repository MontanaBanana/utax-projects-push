...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Real Tax Solutions', 'Real Tax Solutions', 'https://taxmobileapp.com/images/projects/353-icon.png', 'https://taxmobileapp.com/share/353'); }
