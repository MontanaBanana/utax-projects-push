...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Alaska Tax Lady', 'Alaska Tax Lady', 'https://taxmobileapp.com/images/projects/259-icon.png', 'https://taxmobileapp.com/share/259'); }
