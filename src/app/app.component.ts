...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Ollis Tax Accounting', 'Ollis Tax Accounting', 'https://taxmobileapp.com/images/projects/294-icon.png', 'https://taxmobileapp.com/share/294'); }
