...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Latin American Multiservices LLC', 'Latin American Multiservices LLC', 'https://taxmobileapp.com/images/projects/489-icon.png', 'https://taxmobileapp.com/share/489'); }
