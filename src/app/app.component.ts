...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Jamecia Arestil', 'Jamecia Arestil', 'https://taxmobileapp.com/images/projects/544-icon.png', 'https://taxmobileapp.com/share/544'); }
