...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Total Tax Accounting', 'Total Tax Accounting', 'https://taxmobileapp.com/images/projects/264-icon.png', 'https://taxmobileapp.com/share/264'); }
