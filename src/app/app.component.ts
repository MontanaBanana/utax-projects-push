...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('GARY MADDEN BUSINESS SOLUTIONS', 'GARY MADDEN BUSINESS SOLUTIONS', 'https://www.taxmobileapp.com/images/projects/218-icon.png', 'https://www.taxmobileapp.com/share/218'); }
