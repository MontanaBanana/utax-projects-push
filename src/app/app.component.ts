...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Durazos Financial Services', 'Durazos Financial Services', 'https://taxmobileapp.com/images/projects/466-icon.png', 'https://taxmobileapp.com/share/466'); }
