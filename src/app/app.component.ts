...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('L.A. multi services and income tax', 'L.A. multi services and income tax', 'https://taxmobileapp.com/images/projects/408-icon.png', 'https://taxmobileapp.com/share/408'); }
