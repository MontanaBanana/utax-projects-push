...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Unrivaled Tax Associates, Inc.', 'Unrivaled Tax Associates, Inc.', 'https://www.taxmobileapp.com/images/projects/227-icon.png', 'https://www.taxmobileapp.com/share/227'); }
