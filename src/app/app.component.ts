...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('J&G Armadillo Tax Service LLC', 'J&G Armadillo Tax Service LLC', 'https://taxmobileapp.com/images/projects/210-icon.png', 'https://taxmobileapp.com/share/210'); }
