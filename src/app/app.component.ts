...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Enoch Reliable Tax Services', 'Enoch Reliable Tax Services', 'https://taxmobileapp.com/images/projects/300-icon.png', 'https://taxmobileapp.com/share/300'); }
