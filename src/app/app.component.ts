...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Hands of Time Tax', 'Hands of Time Tax', 'https://taxmobileapp.com/images/projects/197-icon.png', 'https://taxmobileapp.com/share/197'); }
