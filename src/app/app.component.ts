...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Taxguruette', 'Taxguruette', 'https://www.taxmobileapp.com/images/projects/144-icon.png', 'https://www.taxmobileapp.com/share/144'); }
