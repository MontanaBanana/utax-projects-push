...
@Component({
  templateUrl: 'https://taxmobileapp.com/apptemplate/app/546'
})
export class MyApp {
  ...
  openShare() { this.socialSharing.share('The Tax Bizz', 'The Tax Bizz', 'https://taxmobileapp.com/images/projects/546-icon.png', 'https://taxmobileapp.com/share/546'); }
