...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Llavore Tax Service', 'Llavore Tax Service', 'https://taxmobileapp.com/images/projects/486-icon.png', 'https://taxmobileapp.com/share/486'); }
