...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Avia Tax Services ', 'Avia Tax Services ', 'https://taxmobileapp.com/images/projects/94-icon.png', 'https://taxmobileapp.com/share/94'); }
