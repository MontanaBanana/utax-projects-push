...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Alexandria Tax Solutions', 'Alexandria Tax Solutions', 'https://www.taxmobileapp.com/images/projects/182-icon.png', 'https://www.taxmobileapp.com/share/182'); }
