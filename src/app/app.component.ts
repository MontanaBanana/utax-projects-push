...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Covenant Tax Company', 'Covenant Tax Company', 'https://www.taxmobileapp.com/images/projects/203-icon.png', 'https://www.taxmobileapp.com/share/203'); }
