...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('First Tax Software, LLC', 'First Tax Software, LLC', 'https://www.taxmobileapp.com/images/projects/96-icon.png', 'https://www.taxmobileapp.com/share/96'); }
