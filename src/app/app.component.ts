...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Have You Heard Tax Service', 'Have You Heard Tax Service', 'https://taxmobileapp.com/images/projects/204-icon.png', 'https://taxmobileapp.com/share/204'); }
