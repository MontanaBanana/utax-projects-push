...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Loyalty Professional Tax Service', 'Loyalty Professional Tax Service', 'https://www.taxmobileapp.com/images/projects/81-icon.png', 'https://www.taxmobileapp.com/share/81'); }
