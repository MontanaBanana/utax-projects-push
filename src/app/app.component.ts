...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Y’ Solutions Taxes', 'Y’ Solutions Taxes', 'https://www.taxmobileapp.com/images/projects/145-icon.png', 'https://www.taxmobileapp.com/share/145'); }
