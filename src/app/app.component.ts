...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('A Income Tax and Multiservice', 'A Income Tax and Multiservice', 'https://taxmobileapp.com/images/projects/420-icon.png', 'https://taxmobileapp.com/share/420'); }
