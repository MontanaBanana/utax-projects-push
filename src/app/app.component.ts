...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Waterman Realty and Tax Pro', 'Waterman Realty and Tax Pro', 'https://taxmobileapp.com/images/projects/180-icon.png', 'https://taxmobileapp.com/share/180'); }
