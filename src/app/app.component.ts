...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('TaxPros Financial Group inc', 'TaxPros Financial Group inc', 'https://taxmobileapp.com/images/projects/453-icon.png', 'https://taxmobileapp.com/share/453'); }
