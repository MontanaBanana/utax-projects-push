...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Evelyns Tax Service', 'Evelyns Tax Service', 'https://taxmobileapp.com/images/projects/525-icon.png', 'https://taxmobileapp.com/share/525'); }
