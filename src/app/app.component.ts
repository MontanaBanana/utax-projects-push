...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Prosperity Pro Tax', 'Prosperity Pro Tax', 'https://taxmobileapp.com/images/projects/516-icon.png', 'https://taxmobileapp.com/share/516'); }
