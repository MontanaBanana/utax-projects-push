...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Tax Dynasty Financial Services', 'Tax Dynasty Financial Services', 'https://taxmobileapp.com/images/projects/303-icon.png', 'https://taxmobileapp.com/share/303'); }
