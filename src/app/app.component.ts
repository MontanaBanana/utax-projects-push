...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Tax Source Group- DB', 'Tax Source Group- DB', 'https://taxmobileapp.com/images/projects/87-icon.png', 'https://taxmobileapp.com/share/87'); }
