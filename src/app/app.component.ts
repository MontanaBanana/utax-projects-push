...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Gaynair Financial Services DBA GP Angels LA Tax Services ', 'Gaynair Financial Services DBA GP Angels LA Tax Services ', 'https://taxmobileapp.com/images/projects/56-icon.png', 'https://taxmobileapp.com/share/56'); }
