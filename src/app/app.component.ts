...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Cathy’s Printing and Tax Service', 'Cathy’s Printing and Tax Service', 'https://www.taxmobileapp.com/images/projects/65-icon.png', 'https://www.taxmobileapp.com/share/65'); }
