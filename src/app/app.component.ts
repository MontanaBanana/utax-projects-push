...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Flourish Financial Group', 'Flourish Financial Group', 'https://taxmobileapp.com/images/projects/444-icon.png', 'https://taxmobileapp.com/share/444'); }
