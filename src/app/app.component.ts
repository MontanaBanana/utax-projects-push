...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Better Days Tax Service', 'Better Days Tax Service', 'https://taxmobileapp.com/images/projects/93-icon.png', 'https://taxmobileapp.com/share/93'); }
