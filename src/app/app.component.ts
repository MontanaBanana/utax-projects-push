...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('MAYOS TAX SERVICE', 'MAYOS TAX SERVICE', 'https://taxmobileapp.com/images/projects/401-icon.png', 'https://taxmobileapp.com/share/401'); }
