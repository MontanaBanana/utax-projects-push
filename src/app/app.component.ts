...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Reliable Tax, LLC', 'Reliable Tax, LLC', 'https://www.taxmobileapp.com/images/projects/276-icon.png', 'https://www.taxmobileapp.com/share/276'); }
