...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Phenomenal Tax & Notary Services', 'Phenomenal Tax & Notary Services', 'https://taxmobileapp.com/images/projects/362-icon.png', 'https://taxmobileapp.com/share/362'); }
