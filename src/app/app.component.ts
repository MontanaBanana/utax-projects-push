...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Unique Marketing & Financial Services', 'Unique Marketing & Financial Services', 'https://taxmobileapp.com/images/projects/309-icon.png', 'https://taxmobileapp.com/share/309'); }
