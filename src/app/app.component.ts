...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('ECOTAX SOLUTIONS', 'ECOTAX SOLUTIONS', 'https://taxmobileapp.com/images/projects/230-icon.png', 'https://taxmobileapp.com/share/230'); }
