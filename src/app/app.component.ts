...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Master Tax Services', 'Master Tax Services', 'https://taxmobileapp.com/images/projects/174-icon.png', 'https://taxmobileapp.com/share/174'); }
