...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Artiga’s Professional Service', 'Artiga’s Professional Service', 'https://taxmobileapp.com/images/projects/484-icon.png', 'https://taxmobileapp.com/share/484'); }
