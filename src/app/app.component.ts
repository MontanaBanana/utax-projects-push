...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('A. M. Accounting & Taxes', 'A. M. Accounting & Taxes', 'https://taxmobileapp.com/images/projects/540-icon.png', 'https://taxmobileapp.com/share/540'); }
