...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('GoTax Tax Service', 'GoTax Tax Service', 'https://taxmobileapp.com/images/projects/111-icon.png', 'https://taxmobileapp.com/share/111'); }
