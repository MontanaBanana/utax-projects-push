...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Legacy Tax Professionals', 'Legacy Tax Professionals', 'https://taxmobileapp.com/images/projects/47-icon.png', 'https://taxmobileapp.com/share/47'); }
