...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('seVen Tax Software', 'seVen Tax Software', 'https://taxmobileapp.com/images/projects/254-icon.png', 'https://taxmobileapp.com/share/254'); }
