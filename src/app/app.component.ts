...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Texas Rose Tax Services', 'Texas Rose Tax Services', 'https://taxmobileapp.com/images/projects/393-icon.png', 'https://taxmobileapp.com/share/393'); }
