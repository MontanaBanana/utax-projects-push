...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Creole Queens Tax Pros', 'Creole Queens Tax Pros', 'https://taxmobileapp.com/images/projects/396-icon.png', 'https://taxmobileapp.com/share/396'); }
