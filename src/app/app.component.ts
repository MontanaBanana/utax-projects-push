...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Bass Tax Associates', 'Bass Tax Associates', 'https://taxmobileapp.com/images/projects/273-icon.png', 'https://taxmobileapp.com/share/273'); }
