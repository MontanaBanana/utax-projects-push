...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('SuperTax, Inc', 'SuperTax, Inc', 'https://www.taxmobileapp.com/images/projects/150-icon.png', 'https://www.taxmobileapp.com/share/150'); }
