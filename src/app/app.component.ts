...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Trupoint Tax Services', 'Trupoint Tax Services', 'https://taxmobileapp.com/images/projects/282-icon.png', 'https://taxmobileapp.com/share/282'); }
