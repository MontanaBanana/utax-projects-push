...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Secure tax financial', 'Secure tax financial', 'https://taxmobileapp.com/images/projects/473-icon.png', 'https://taxmobileapp.com/share/473'); }
