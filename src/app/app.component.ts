...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Diamond Tax Group', 'Diamond Tax Group', 'https://taxmobileapp.com/images/projects/386-icon.png', 'https://taxmobileapp.com/share/386'); }
