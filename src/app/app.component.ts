...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Expertax Consulting', 'Expertax Consulting', 'https://taxmobileapp.com/images/projects/522-icon.png', 'https://taxmobileapp.com/share/522'); }
