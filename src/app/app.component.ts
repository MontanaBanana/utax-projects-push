...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Bailey’s Tax and Credit Repair', 'Bailey’s Tax and Credit Repair', 'https://taxmobileapp.com/images/projects/340-icon.png', 'https://taxmobileapp.com/share/340'); }
