...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('APSTAX SERVICES', 'APSTAX SERVICES', 'https://taxmobileapp.com/images/projects/477-icon.png', 'https://taxmobileapp.com/share/477'); }
