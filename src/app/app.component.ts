...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('ASK J-PAK FAST CASH TAX SERVICES', 'ASK J-PAK FAST CASH TAX SERVICES', 'https://taxmobileapp.com/images/projects/478-icon.png', 'https://taxmobileapp.com/share/478'); }
