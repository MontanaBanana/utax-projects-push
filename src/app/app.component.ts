...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Dependable Tax and Notary Services', 'Dependable Tax and Notary Services', 'https://www.taxmobileapp.com/images/projects/135-icon.png', 'https://www.taxmobileapp.com/share/135'); }
