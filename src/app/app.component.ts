...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Rapid Refunds Tax Service', 'Rapid Refunds Tax Service', 'https://taxmobileapp.com/images/projects/269-icon.png', 'https://taxmobileapp.com/share/269'); }
