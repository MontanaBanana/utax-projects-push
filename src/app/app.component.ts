...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Nationwide Numbers Financial Services, Inc.', 'Nationwide Numbers Financial Services, Inc.', 'https://www.taxmobileapp.com/images/projects/168-icon.png', 'https://www.taxmobileapp.com/share/168'); }
