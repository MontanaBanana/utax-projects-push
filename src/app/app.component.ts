...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Heritage Income Tax Services', 'Heritage Income Tax Services', 'https://taxmobileapp.com/images/projects/541-icon.png', 'https://taxmobileapp.com/share/541'); }
