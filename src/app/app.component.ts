...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Silver State Tax and Multiservices', 'Silver State Tax and Multiservices', 'https://www.taxmobileapp.com/images/projects/154-icon.png', 'https://www.taxmobileapp.com/share/154'); }
