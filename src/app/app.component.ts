...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Batten Financial Services', 'Batten Financial Services', 'https://taxmobileapp.com/images/projects/194-icon.png', 'https://taxmobileapp.com/share/194'); }
