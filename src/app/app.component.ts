...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Fausto Rodriguez', 'Fausto Rodriguez', 'https://taxmobileapp.com/images/projects/415-icon.png', 'https://taxmobileapp.com/share/415'); }
