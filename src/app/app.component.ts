...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Lozanos Tax Services', 'Lozanos Tax Services', 'https://taxmobileapp.com/images/projects/502-icon.png', 'https://taxmobileapp.com/share/502'); }
