...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Superior Tax Prep, Inc.', 'Superior Tax Prep, Inc.', 'https://taxmobileapp.com/images/projects/253-icon.png', 'https://taxmobileapp.com/share/253'); }
