...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('CTS Tax & Accounting ', 'CTS Tax & Accounting ', 'https://taxmobileapp.com/images/projects/78-icon.png', 'https://taxmobileapp.com/share/78'); }
