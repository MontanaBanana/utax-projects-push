...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('M and D ACCOUNTING SERVICES INC', 'M and D ACCOUNTING SERVICES INC', 'https://taxmobileapp.com/images/projects/125-icon.png', 'https://taxmobileapp.com/share/125'); }
