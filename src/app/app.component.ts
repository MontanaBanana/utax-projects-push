...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Tax Feeder Software', 'Tax Feeder Software', 'https://taxmobileapp.com/images/projects/543-icon.png', 'https://taxmobileapp.com/share/543'); }
