...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Ramsey’s tax office', 'Ramsey’s tax office', 'https://taxmobileapp.com/images/projects/472-icon.png', 'https://taxmobileapp.com/share/472'); }
