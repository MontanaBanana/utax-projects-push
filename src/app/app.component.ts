...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('LOMAX TAX AND FINANCIAL SERVICES', 'LOMAX TAX AND FINANCIAL SERVICES', 'https://taxmobileapp.com/images/projects/308-icon.png', 'https://taxmobileapp.com/share/308'); }
