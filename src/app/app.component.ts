...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Premier Mobile Tax Service ', 'Premier Mobile Tax Service ', 'https://taxmobileapp.com/images/projects/73-icon.png', 'https://taxmobileapp.com/share/73'); }
