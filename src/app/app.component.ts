...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Gana Yang Tax Service', 'Gana Yang Tax Service', 'https://www.taxmobileapp.com/images/projects/138-icon.png', 'https://www.taxmobileapp.com/share/138'); }
