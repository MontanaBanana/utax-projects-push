...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('BEC Income Tax Preparations', 'BEC Income Tax Preparations', 'https://www.taxmobileapp.com/images/projects/39-icon.png', 'https://www.taxmobileapp.com/share/39'); }
