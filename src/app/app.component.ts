...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Donald Enterprises II, LLC', 'Donald Enterprises II, LLC', 'https://taxmobileapp.com/images/projects/335-icon.png', 'https://taxmobileapp.com/share/335'); }
