...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Reliable Tax LLC', 'Reliable Tax LLC', 'https://taxmobileapp.com/images/projects/276-icon.png', 'https://taxmobileapp.com/share/276'); }
