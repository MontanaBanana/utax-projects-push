...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Priority Refund', 'Priority Refund', 'https://www.taxmobileapp.com/images/projects/183-icon.png', 'https://www.taxmobileapp.com/share/183'); }
