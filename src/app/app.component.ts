...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('VH Income Tax Service', 'VH Income Tax Service', 'https://taxmobileapp.com/images/projects/490-icon.png', 'https://taxmobileapp.com/share/490'); }
