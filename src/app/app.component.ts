...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('CA’S TAX ENTERPRISE', 'CA’S TAX ENTERPRISE', 'https://taxmobileapp.com/images/projects/515-icon.png', 'https://taxmobileapp.com/share/515'); }
