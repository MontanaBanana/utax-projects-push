...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Community 1st Tax ', 'Community 1st Tax ', 'https://taxmobileapp.com/images/projects/50-icon.png', 'https://taxmobileapp.com/share/50'); }
