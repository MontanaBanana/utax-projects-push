...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('ALL CITIZEN TAX', 'ALL CITIZEN TAX', 'https://taxmobileapp.com/images/projects/289-icon.png', 'https://taxmobileapp.com/share/289'); }
