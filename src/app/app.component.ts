...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Oxford Advisory Group', 'Oxford Advisory Group', 'https://taxmobileapp.com/images/projects/409-icon.png', 'https://taxmobileapp.com/share/409'); }
