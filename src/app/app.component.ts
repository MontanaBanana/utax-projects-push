...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('W2 Tax Pros LLC', 'W2 Tax Pros LLC', 'https://taxmobileapp.com/images/projects/172-icon.png', 'https://taxmobileapp.com/share/172'); }
