...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Tax Plus Etc', 'Tax Plus Etc', 'https://www.taxmobileapp.com/images/projects/266-icon.png', 'https://www.taxmobileapp.com/share/266'); }
