...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Global Mobile Tax Service ', 'Global Mobile Tax Service ', 'https://taxmobileapp.com/images/projects/317-icon.png', 'https://taxmobileapp.com/share/317'); }
