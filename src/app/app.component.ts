...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Integrity Tax Services, LLC', 'Integrity Tax Services, LLC', 'https://www.taxmobileapp.com/images/projects/181-icon.png', 'https://www.taxmobileapp.com/share/181'); }
