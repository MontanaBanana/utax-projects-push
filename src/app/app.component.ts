...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Great Lakes Tax and Loans', 'Great Lakes Tax and Loans', 'https://taxmobileapp.com/images/projects/355-icon.png', 'https://taxmobileapp.com/share/355'); }
