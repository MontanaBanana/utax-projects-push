...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('GTax Mobile', 'GTax Mobile', 'https://www.taxmobileapp.com/images/projects/191-icon.png', 'https://www.taxmobileapp.com/share/191'); }
