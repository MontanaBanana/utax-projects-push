...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('First Tax Software LLC', 'First Tax Software LLC', 'https://taxmobileapp.com/images/projects/96-icon.png', 'https://taxmobileapp.com/share/96'); }
