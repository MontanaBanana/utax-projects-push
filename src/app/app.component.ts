...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('LB LUXURY TAX SERVICES', 'LB LUXURY TAX SERVICES', 'https://taxmobileapp.com/images/projects/301-icon.png', 'https://taxmobileapp.com/share/301'); }
