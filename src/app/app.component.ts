...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Precision Capital', 'Precision Capital', 'https://taxmobileapp.com/images/projects/304-icon.png', 'https://taxmobileapp.com/share/304'); }
