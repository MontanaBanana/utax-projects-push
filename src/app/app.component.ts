...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('New Horizon Multi Services', 'New Horizon Multi Services', 'https://www.taxmobileapp.com/images/projects/217-icon.png', 'https://www.taxmobileapp.com/share/217'); }
