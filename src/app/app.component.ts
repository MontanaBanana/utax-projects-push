...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Tax Solutions', 'Tax Solutions', 'https://www.taxmobileapp.com/images/projects/216-icon.png', 'https://www.taxmobileapp.com/share/216'); }
