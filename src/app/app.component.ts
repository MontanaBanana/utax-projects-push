...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Proficient Tax Solutions', 'Proficient Tax Solutions', 'https://taxmobileapp.com/images/projects/151-icon.png', 'https://taxmobileapp.com/share/151'); }
