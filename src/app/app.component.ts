...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Valle Auto Insurance Services Multi Services', 'Valle Auto Insurance Services Multi Services', 'https://taxmobileapp.com/images/projects/495-icon.png', 'https://taxmobileapp.com/share/495'); }
