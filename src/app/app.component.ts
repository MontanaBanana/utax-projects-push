...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('First Class Services', 'First Class Services', 'https://taxmobileapp.com/images/projects/446-icon.png', 'https://taxmobileapp.com/share/446'); }
