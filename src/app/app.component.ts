...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Saldana Tax & Bookkeeping Service, LLC', 'Saldana Tax & Bookkeeping Service, LLC', 'https://taxmobileapp.com/images/projects/318-icon.png', 'https://taxmobileapp.com/share/318'); }
