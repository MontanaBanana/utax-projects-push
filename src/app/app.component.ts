...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Anchor Tax and Bookkeeping Service', 'Anchor Tax and Bookkeeping Service', 'https://taxmobileapp.com/images/projects/148-icon.png', 'https://taxmobileapp.com/share/148'); }
