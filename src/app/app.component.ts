...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Ivy League Tax Service', 'Ivy League Tax Service', 'https://taxmobileapp.com/images/projects/348-icon.png', 'https://taxmobileapp.com/share/348'); }
