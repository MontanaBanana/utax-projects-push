...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('True Tax Services LLC', 'True Tax Services LLC', 'https://taxmobileapp.com/images/projects/213-icon.png', 'https://taxmobileapp.com/share/213'); }
