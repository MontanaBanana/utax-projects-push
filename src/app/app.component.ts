...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Compu-Billing Inc', 'Compu-Billing Inc', 'https://taxmobileapp.com/images/projects/155-icon.png', 'https://taxmobileapp.com/share/155'); }
