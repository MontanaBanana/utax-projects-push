...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('ADVENT FINANCIAL CORPORATION', 'ADVENT FINANCIAL CORPORATION', 'https://www.taxmobileapp.com/images/projects/136-icon.png', 'https://www.taxmobileapp.com/share/136'); }
