...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Tru Tax and Credit Solutions', 'Tru Tax and Credit Solutions', 'https://taxmobileapp.com/images/projects/193-icon.png', 'https://taxmobileapp.com/share/193'); }
