...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('CONTADORES ASOCIADOS 2', 'CONTADORES ASOCIADOS 2', 'https://taxmobileapp.com/images/projects/499-icon.png', 'https://taxmobileapp.com/share/499'); }
