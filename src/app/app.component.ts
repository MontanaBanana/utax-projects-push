...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Mi Casita Taxes & Services', 'Mi Casita Taxes & Services', 'https://taxmobileapp.com/images/projects/326-icon.png', 'https://taxmobileapp.com/share/326'); }
