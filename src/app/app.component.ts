...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Angie’s Bookkeeping &Tax Services', 'Angie’s Bookkeeping &Tax Services', 'https://taxmobileapp.com/images/projects/475-icon.png', 'https://taxmobileapp.com/share/475'); }
