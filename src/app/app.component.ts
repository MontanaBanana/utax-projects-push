...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Royalty Tax Software', 'Royalty Tax Software', 'https://www.taxmobileapp.com/images/projects/167-icon.png', 'https://www.taxmobileapp.com/share/167'); }
