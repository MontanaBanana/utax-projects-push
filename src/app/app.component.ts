...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Law Tax Business Services', 'Law Tax Business Services', 'https://taxmobileapp.com/images/projects/479-icon.png', 'https://taxmobileapp.com/share/479'); }
