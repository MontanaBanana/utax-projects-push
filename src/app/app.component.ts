...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('TBA Tax Group', 'TBA Tax Group', 'https://www.taxmobileapp.com/images/projects/192-icon.png', 'https://www.taxmobileapp.com/share/192'); }
