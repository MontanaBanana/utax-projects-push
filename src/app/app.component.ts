...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Checks and Balances Texas', 'Checks and Balances Texas', 'https://taxmobileapp.com/images/projects/452-icon.png', 'https://taxmobileapp.com/share/452'); }
