...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Pro-Tax Business Services', 'Pro-Tax Business Services', 'https://taxmobileapp.com/images/projects/481-icon.png', 'https://taxmobileapp.com/share/481'); }
