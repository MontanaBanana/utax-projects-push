...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Texas Tax Refund Solution', 'Texas Tax Refund Solution', 'https://taxmobileapp.com/images/projects/63-icon.png', 'https://taxmobileapp.com/share/63'); }
