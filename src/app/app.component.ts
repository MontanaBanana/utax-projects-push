...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('844 Tax Team', '844 Tax Team', 'https://www.taxmobileapp.com/images/projects/160-icon.png', 'https://www.taxmobileapp.com/share/160'); }
