...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Elite Money Tax Service', 'Elite Money Tax Service', 'https://taxmobileapp.com/images/projects/382-icon.png', 'https://taxmobileapp.com/share/382'); }
