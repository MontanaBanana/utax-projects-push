...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Vertical Accounting & Tax', 'Vertical Accounting & Tax', 'https://www.taxmobileapp.com/images/projects/208-icon.png', 'https://www.taxmobileapp.com/share/208'); }
