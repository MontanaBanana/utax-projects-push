...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Nationwide Consumer Services', 'Nationwide Consumer Services', 'https://www.taxmobileapp.com/images/projects/195-icon.png', 'https://www.taxmobileapp.com/share/195'); }
