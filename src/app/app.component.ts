...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Busy Bee Income Tax', 'Busy Bee Income Tax', 'https://taxmobileapp.com/images/projects/524-icon.png', 'https://taxmobileapp.com/share/524'); }
