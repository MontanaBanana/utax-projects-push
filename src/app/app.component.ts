...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Spectrum Tax Group', 'Spectrum Tax Group', 'https://taxmobileapp.com/images/projects/324-icon.png', 'https://taxmobileapp.com/share/324'); }
