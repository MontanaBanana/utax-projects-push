...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Trupoint Tax Service', 'Trupoint Tax Service', 'https://taxmobileapp.com/images/projects/282-icon.png', 'https://taxmobileapp.com/share/282'); }
