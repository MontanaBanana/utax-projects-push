...
@Component({
  templateUrl: 'https://www.taxmobileapp.com/apptemplate/app/279'
})
export class MyApp {
  ...
  openShare() { this.socialSharing.share('EXQUISITE CONSULTING', 'EXQUISITE CONSULTING', 'https://www.taxmobileapp.com/images/projects/279-icon.png', 'https://www.taxmobileapp.com/share/279'); }
