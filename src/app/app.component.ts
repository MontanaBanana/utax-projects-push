...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Future Financial Services', 'Future Financial Services', 'https://www.taxmobileapp.com/images/projects/84-icon.png', 'https://www.taxmobileapp.com/share/84'); }
