...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Superior Tax Prep by HFK Services', 'Superior Tax Prep by HFK Services', 'https://taxmobileapp.com/images/projects/253-icon.png', 'https://taxmobileapp.com/share/253'); }
