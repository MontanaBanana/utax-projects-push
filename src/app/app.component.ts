...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Early Byrd Express', 'Early Byrd Express', 'https://taxmobileapp.com/images/projects/400-icon.png', 'https://taxmobileapp.com/share/400'); }
