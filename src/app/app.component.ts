...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Robinson Tax Group', 'Robinson Tax Group', 'https://taxmobileapp.com/images/projects/460-icon.png', 'https://taxmobileapp.com/share/460'); }
