...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Williams Tax Service', 'Williams Tax Service', 'https://www.taxmobileapp.com/images/projects/219-icon.png', 'https://www.taxmobileapp.com/share/219'); }
