...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Hands On Tax Service', 'Hands On Tax Service', 'https://taxmobileapp.com/images/projects/198-icon.png', 'https://taxmobileapp.com/share/198'); }
