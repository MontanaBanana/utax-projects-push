...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('EOV Risk Managemen', 'EOV Risk Managemen', 'https://taxmobileapp.com/images/projects/375-icon.png', 'https://taxmobileapp.com/share/375'); }
