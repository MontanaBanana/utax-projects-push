...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Pull Up On Ya Tax & Financial Solutions', 'Pull Up On Ya Tax & Financial Solutions', 'https://taxmobileapp.com/images/projects/372-icon.png', 'https://taxmobileapp.com/share/372'); }
