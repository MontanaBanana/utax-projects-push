...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Violeta Caro Tax and Notary', 'Violeta Caro Tax and Notary', 'https://taxmobileapp.com/images/projects/376-icon.png', 'https://taxmobileapp.com/share/376'); }
