...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('VOLCY FINANCIAL SERVICES', 'VOLCY FINANCIAL SERVICES', 'https://taxmobileapp.com/images/projects/310-icon.png', 'https://taxmobileapp.com/share/310'); }
