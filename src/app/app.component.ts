...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Harvest Time Tax Financial Services', 'Harvest Time Tax Financial Services', 'https://taxmobileapp.com/images/projects/165-icon.png', 'https://taxmobileapp.com/share/165'); }
