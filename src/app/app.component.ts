...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Super Tax & Services', 'Super Tax & Services', 'https://taxmobileapp.com/images/projects/215-icon.png', 'https://taxmobileapp.com/share/215'); }
