...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('COMMUNITY FIRST TAX SERVICE', 'COMMUNITY FIRST TAX SERVICE', 'https://taxmobileapp.com/images/projects/85-icon.png', 'https://taxmobileapp.com/share/85'); }
