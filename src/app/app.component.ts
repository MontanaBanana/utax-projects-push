...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('eTAX Software/HP Tax and Financial Services', 'eTAX Software/HP Tax and Financial Services', 'https://taxmobileapp.com/images/projects/92-icon.png', 'https://taxmobileapp.com/share/92'); }
