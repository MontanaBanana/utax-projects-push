...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('C & H tax service', 'C & H tax service', 'https://taxmobileapp.com/images/projects/388-icon.png', 'https://taxmobileapp.com/share/388'); }
