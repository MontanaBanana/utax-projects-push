...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Kelly Tax Service', 'Kelly Tax Service', 'https://taxmobileapp.com/images/projects/77-icon.png', 'https://taxmobileapp.com/share/77'); }
