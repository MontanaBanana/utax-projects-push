...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Deborah T Papetti & Associates', 'Deborah T Papetti & Associates', 'https://taxmobileapp.com/images/projects/542-icon.png', 'https://taxmobileapp.com/share/542'); }
