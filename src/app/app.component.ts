...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('LA Tax & Associates', 'LA Tax & Associates', 'https://taxmobileapp.com/images/projects/364-icon.png', 'https://taxmobileapp.com/share/364'); }
