...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Daisy’s Income Tax Services', 'Daisy’s Income Tax Services', 'https://taxmobileapp.com/images/projects/293-icon.png', 'https://taxmobileapp.com/share/293'); }
