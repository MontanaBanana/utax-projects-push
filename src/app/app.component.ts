...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Xpert Tax and Financial ', 'Xpert Tax and Financial ', 'https://taxmobileapp.com/images/projects/97-icon.png', 'https://taxmobileapp.com/share/97'); }
