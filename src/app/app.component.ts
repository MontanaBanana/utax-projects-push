...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('CDL Tax Service', 'CDL Tax Service', 'https://www.taxmobileapp.com/images/projects/222-icon.png', 'https://www.taxmobileapp.com/share/222'); }
