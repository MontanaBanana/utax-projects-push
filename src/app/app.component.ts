...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Brown & Associates Tax and Accounting', 'Brown & Associates Tax and Accounting', 'https://taxmobileapp.com/images/projects/271-icon.png', 'https://taxmobileapp.com/share/271'); }
