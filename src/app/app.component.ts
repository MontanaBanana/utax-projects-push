...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Chester and Chester Income Tax Service', 'Chester and Chester Income Tax Service', 'https://www.taxmobileapp.com/images/projects/46-icon.png', 'https://www.taxmobileapp.com/share/46'); }
