...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('ADA Tax Services', 'ADA Tax Services', 'https://taxmobileapp.com/images/projects/349-icon.png', 'https://taxmobileapp.com/share/349'); }
