...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('LJ Accounting and Consultants', 'LJ Accounting and Consultants', 'https://taxmobileapp.com/images/projects/498-icon.png', 'https://taxmobileapp.com/share/498'); }
