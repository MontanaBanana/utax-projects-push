...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('ADRIANAS INCOME.TAX & SERVICES', 'ADRIANAS INCOME.TAX & SERVICES', 'https://taxmobileapp.com/images/projects/425-icon.png', 'https://taxmobileapp.com/share/425'); }
