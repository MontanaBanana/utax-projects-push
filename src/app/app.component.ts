...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('JP & A Tax Services', 'JP & A Tax Services', 'https://www.taxmobileapp.com/images/projects/229-icon.png', 'https://www.taxmobileapp.com/share/229'); }
