...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Smiley Tax Service', 'Smiley Tax Service', 'https://taxmobileapp.com/images/projects/188-icon.png', 'https://taxmobileapp.com/share/188'); }
