...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Texas Tax and More', 'Texas Tax and More', 'https://taxmobileapp.com/images/projects/419-icon.png', 'https://taxmobileapp.com/share/419'); }
