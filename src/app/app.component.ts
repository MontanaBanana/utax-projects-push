...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Coleman Tax Services', 'Coleman Tax Services', 'https://taxmobileapp.com/images/projects/422-icon.png', 'https://taxmobileapp.com/share/422'); }
