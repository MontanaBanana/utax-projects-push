...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Tax Express and More', 'Tax Express and More', 'https://taxmobileapp.com/images/projects/394-icon.png', 'https://taxmobileapp.com/share/394'); }
