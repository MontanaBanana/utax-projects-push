...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Detailed Tax Services', 'Detailed Tax Services', 'https://www.taxmobileapp.com/images/projects/202-icon.png', 'https://www.taxmobileapp.com/share/202'); }
