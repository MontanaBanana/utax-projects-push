...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Cerulean Tax Solutions', 'Cerulean Tax Solutions', 'https://www.taxmobileapp.com/images/projects/257-icon.png', 'https://www.taxmobileapp.com/share/257'); }
