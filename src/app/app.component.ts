...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Fox’s Tax Service Inc', 'Fox’s Tax Service Inc', 'https://taxmobileapp.com/images/projects/287-icon.png', 'https://taxmobileapp.com/share/287'); }
