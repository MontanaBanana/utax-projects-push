...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Smothermons Tax Service', 'Smothermons Tax Service', 'https://taxmobileapp.com/images/projects/421-icon.png', 'https://taxmobileapp.com/share/421'); }
