...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Roadrunner Tax  LLC DB', 'Roadrunner Tax  LLC DB', 'https://taxmobileapp.com/images/projects/71-icon.png', 'https://taxmobileapp.com/share/71'); }
