...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('VRF FINANCIAL GROUP', 'VRF FINANCIAL GROUP', 'https://taxmobileapp.com/images/projects/232-icon.png', 'https://taxmobileapp.com/share/232'); }
