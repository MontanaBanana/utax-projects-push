...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Michelle Murphy Tax Services', 'Michelle Murphy Tax Services', 'https://taxmobileapp.com/images/projects/454-icon.png', 'https://taxmobileapp.com/share/454'); }
