...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('T-N-T Tax Services, LLC', 'T-N-T Tax Services, LLC', 'https://taxmobileapp.com/images/projects/133-icon.png', 'https://taxmobileapp.com/share/133'); }
