...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('ETFS Express Tax & Financial Services', 'ETFS Express Tax & Financial Services', 'https://taxmobileapp.com/images/projects/365-icon.png', 'https://taxmobileapp.com/share/365'); }
