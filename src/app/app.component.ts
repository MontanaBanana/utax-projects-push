...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Triangle Tax Group', 'Triangle Tax Group', 'https://www.taxmobileapp.com/images/projects/166-icon.png', 'https://www.taxmobileapp.com/share/166'); }
