...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('T Martin Tax Service', 'T Martin Tax Service', 'https://taxmobileapp.com/images/projects/329-icon.png', 'https://taxmobileapp.com/share/329'); }
