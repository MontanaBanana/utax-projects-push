...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Abacus Tax Services', 'Abacus Tax Services', 'https://taxmobileapp.com/images/projects/370-icon.png', 'https://taxmobileapp.com/share/370'); }
