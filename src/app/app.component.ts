...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Unified financial', 'Unified financial', 'https://taxmobileapp.com/images/projects/366-icon.png', 'https://taxmobileapp.com/share/366'); }
