...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Surnonia Tax Service', 'Surnonia Tax Service', 'https://taxmobileapp.com/images/projects/243-icon.png', 'https://taxmobileapp.com/share/243'); }
