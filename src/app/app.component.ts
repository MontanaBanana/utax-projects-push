...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('M & Y International Financial Services', 'M & Y International Financial Services', 'https://www.taxmobileapp.com/images/projects/143-icon.png', 'https://www.taxmobileapp.com/share/143'); }
