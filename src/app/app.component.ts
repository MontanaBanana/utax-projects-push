...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Paradise Tax Service', 'Paradise Tax Service', 'https://taxmobileapp.com/images/projects/272-icon.png', 'https://taxmobileapp.com/share/272'); }
