...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Excellence Tax Group', 'Excellence Tax Group', 'https://taxmobileapp.com/images/projects/359-icon.png', 'https://taxmobileapp.com/share/359'); }
