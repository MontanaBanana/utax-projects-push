...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Saldaña’s Tax and Bookkeeping Service', 'Saldaña’s Tax and Bookkeeping Service', 'https://taxmobileapp.com/images/projects/318-icon.png', 'https://taxmobileapp.com/share/318'); }
