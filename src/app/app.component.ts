...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Speedy Tax Service', 'Speedy Tax Service', 'https://www.taxmobileapp.com/images/projects/239-icon.png', 'https://www.taxmobileapp.com/share/239'); }
