...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('More Than Taxes', 'More Than Taxes', 'https://taxmobileapp.com/images/projects/445-icon.png', 'https://taxmobileapp.com/share/445'); }
