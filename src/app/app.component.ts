...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Danity Financials', 'Danity Financials', 'https://taxmobileapp.com/images/projects/462-icon.png', 'https://taxmobileapp.com/share/462'); }
