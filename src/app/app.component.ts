...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Cooper Tax Services', 'Cooper Tax Services', 'https://taxmobileapp.com/images/projects/311-icon.png', 'https://taxmobileapp.com/share/311'); }
