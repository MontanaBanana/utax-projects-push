...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('The Tax Spa Elite Tax Preparation', 'The Tax Spa Elite Tax Preparation', 'https://taxmobileapp.com/images/projects/528-icon.png', 'https://taxmobileapp.com/share/528'); }
