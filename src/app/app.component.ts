...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Z3 Financial Services', 'Z3 Financial Services', 'https://taxmobileapp.com/images/projects/153-icon.png', 'https://taxmobileapp.com/share/153'); }
