...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Trupoint Marketing', 'Trupoint Marketing', 'https://taxmobileapp.com/images/projects/282-icon.png', 'https://taxmobileapp.com/share/282'); }
