...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Blessed Express Tax Service', 'Blessed Express Tax Service', 'https://www.taxmobileapp.com/images/projects/127-icon.png', 'https://www.taxmobileapp.com/share/127'); }
