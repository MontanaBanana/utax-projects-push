...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('PEETE TAX SERVICE', 'PEETE TAX SERVICE', 'https://taxmobileapp.com/images/projects/455-icon.png', 'https://taxmobileapp.com/share/455'); }
