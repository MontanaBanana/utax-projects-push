...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Mi Tierra Multiservices ', 'Mi Tierra Multiservices ', 'https://taxmobileapp.com/images/projects/59-icon.png', 'https://taxmobileapp.com/share/59'); }
