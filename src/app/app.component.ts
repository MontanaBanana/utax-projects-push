...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Powell Tax & Notary Services', 'Powell Tax & Notary Services', 'https://taxmobileapp.com/images/projects/449-icon.png', 'https://taxmobileapp.com/share/449'); }
