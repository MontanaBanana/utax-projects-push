...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Arizons Best Tax Serveces', 'Arizons Best Tax Serveces', 'https://taxmobileapp.com/images/projects/426-icon.png', 'https://taxmobileapp.com/share/426'); }
