...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Gandy’s Accounting & Tax Firm', 'Gandy’s Accounting & Tax Firm', 'https://taxmobileapp.com/images/projects/327-icon.png', 'https://taxmobileapp.com/share/327'); }
