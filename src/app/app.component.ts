...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Joe Blakk Income Tax Service', 'Joe Blakk Income Tax Service', 'https://taxmobileapp.com/images/projects/169-icon.png', 'https://taxmobileapp.com/share/169'); }
