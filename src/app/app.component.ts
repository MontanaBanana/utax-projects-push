...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('GAMA INSURANCE SERVICES', 'GAMA INSURANCE SERVICES', 'https://taxmobileapp.com/images/projects/307-icon.png', 'https://taxmobileapp.com/share/307'); }
