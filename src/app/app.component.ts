...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Tax U Right LLC', 'Tax U Right LLC', 'https://www.taxmobileapp.com/images/projects/226-icon.png', 'https://www.taxmobileapp.com/share/226'); }
