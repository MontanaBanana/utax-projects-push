...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('CampTax Services', 'CampTax Services', 'https://taxmobileapp.com/images/projects/384-icon.png', 'https://taxmobileapp.com/share/384'); }
