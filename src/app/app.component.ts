...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Fel Tabangay Law Office', 'Fel Tabangay Law Office', 'https://taxmobileapp.com/images/projects/504-icon.png', 'https://taxmobileapp.com/share/504'); }
