...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Tracys Tax Service', 'Tracys Tax Service', 'https://taxmobileapp.com/images/projects/424-icon.png', 'https://taxmobileapp.com/share/424'); }
