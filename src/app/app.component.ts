...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('The Rivas Empire', 'The Rivas Empire', 'https://taxmobileapp.com/images/projects/69-icon.png', 'https://taxmobileapp.com/share/69'); }
