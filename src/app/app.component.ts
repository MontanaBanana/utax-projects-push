...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Tax Rats ATL', 'Tax Rats ATL', 'https://www.taxmobileapp.com/images/projects/164-icon.png', 'https://www.taxmobileapp.com/share/164'); }
