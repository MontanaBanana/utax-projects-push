...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Emeryville Tax Service', 'Emeryville Tax Service', 'https://www.taxmobileapp.com/images/projects/101-icon.png', 'https://www.taxmobileapp.com/share/101'); }
