...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Bernard J Walker Income Tax Service', 'Bernard J Walker Income Tax Service', 'https://taxmobileapp.com/images/projects/438-icon.png', 'https://taxmobileapp.com/share/438'); }
