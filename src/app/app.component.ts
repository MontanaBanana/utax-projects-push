...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Freedom Services', 'Freedom Services', 'https://taxmobileapp.com/images/projects/483-icon.png', 'https://taxmobileapp.com/share/483'); }
