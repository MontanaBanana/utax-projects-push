...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Imani Tax & Accounting Service', 'Imani Tax & Accounting Service', 'https://taxmobileapp.com/images/projects/411-icon.png', 'https://taxmobileapp.com/share/411'); }
