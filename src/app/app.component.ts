...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Divine Vision Tax Solutions', 'Divine Vision Tax Solutions', 'https://taxmobileapp.com/images/projects/398-icon.png', 'https://taxmobileapp.com/share/398'); }
