...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Virtuous professional services', 'Virtuous professional services', 'https://taxmobileapp.com/images/projects/470-icon.png', 'https://taxmobileapp.com/share/470'); }
