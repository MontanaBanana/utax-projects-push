...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Family affair tax pros', 'Family affair tax pros', 'https://www.taxmobileapp.com/images/projects/274-icon.png', 'https://www.taxmobileapp.com/share/274'); }
