...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Trustworthy Professional Tax Services', 'Trustworthy Professional Tax Services', 'https://taxmobileapp.com/images/projects/48-icon.png', 'https://taxmobileapp.com/share/48'); }
