...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Volker Best Tax Service', 'Volker Best Tax Service', 'https://taxmobileapp.com/images/projects/530-icon.png', 'https://taxmobileapp.com/share/530'); }
