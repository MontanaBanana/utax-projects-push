...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Awesome Tax Software', 'Awesome Tax Software', 'https://taxmobileapp.com/images/projects/251-icon.png', 'https://taxmobileapp.com/share/251'); }
