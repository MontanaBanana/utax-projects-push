...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('One Way Tax Service', 'One Way Tax Service', 'https://taxmobileapp.com/images/projects/141-icon.png', 'https://taxmobileapp.com/share/141'); }
