...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Cherry’s AAA Tax Services & More', 'Cherry’s AAA Tax Services & More', 'https://taxmobileapp.com/images/projects/360-icon.png', 'https://taxmobileapp.com/share/360'); }
