...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('On Top Tax Services', 'On Top Tax Services', 'https://taxmobileapp.com/images/projects/91-icon.png', 'https://taxmobileapp.com/share/91'); }
