...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Ramirez Tax and Bookkeeping Service', 'Ramirez Tax and Bookkeeping Service', 'https://www.taxmobileapp.com/images/projects/179-icon.png', 'https://www.taxmobileapp.com/share/179'); }
