...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('RDL Enterprises 1 Stop Office Shop by Robert Lloyd', 'RDL Enterprises 1 Stop Office Shop by Robert Lloyd', 'https://taxmobileapp.com/images/projects/285-icon.png', 'https://taxmobileapp.com/share/285'); }
