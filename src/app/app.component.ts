...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Lightpath Wealth Advisors', 'Lightpath Wealth Advisors', 'https://taxmobileapp.com/images/projects/78-icon.png', 'https://taxmobileapp.com/share/78'); }
