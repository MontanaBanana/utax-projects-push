...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('SMB TAX SERVICE', 'SMB TAX SERVICE', 'https://taxmobileapp.com/images/projects/345-icon.png', 'https://taxmobileapp.com/share/345'); }
