...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Advantage Tax', 'Advantage Tax', 'https://www.taxmobileapp.com/images/projects/196-icon.png', 'https://www.taxmobileapp.com/share/196'); }
