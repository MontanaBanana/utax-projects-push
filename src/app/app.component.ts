...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('C&A Professional Tax Service', 'C&A Professional Tax Service', 'https://taxmobileapp.com/images/projects/493-icon.png', 'https://taxmobileapp.com/share/493'); }
