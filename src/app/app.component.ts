...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('1040 Premier Tax Group', '1040 Premier Tax Group', 'https://taxmobileapp.com/images/projects/399-icon.png', 'https://taxmobileapp.com/share/399'); }
