...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Camaras Tax Services', 'Camaras Tax Services', 'https://taxmobileapp.com/images/projects/451-icon.png', 'https://taxmobileapp.com/share/451'); }
