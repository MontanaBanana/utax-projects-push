...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('EL VALLE INSURANCE AND TAX SERVICES', 'EL VALLE INSURANCE AND TAX SERVICES', 'https://taxmobileapp.com/images/projects/255-icon.png', 'https://taxmobileapp.com/share/255'); }
