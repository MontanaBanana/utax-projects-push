...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('LEGACY UNITED SERVICES', 'LEGACY UNITED SERVICES', 'https://taxmobileapp.com/images/projects/374-icon.png', 'https://taxmobileapp.com/share/374'); }
