...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('On Top Tax Services - Oakland', 'On Top Tax Services - Oakland', 'https://taxmobileapp.com/images/projects/199-icon.png', 'https://taxmobileapp.com/share/199'); }
