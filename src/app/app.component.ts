...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('His and Hers Tax Service', 'His and Hers Tax Service', 'https://www.taxmobileapp.com/images/projects/224-icon.png', 'https://www.taxmobileapp.com/share/224'); }
