...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Brumfield Tax Services', 'Brumfield Tax Services', 'https://taxmobileapp.com/images/projects/299-icon.png', 'https://taxmobileapp.com/share/299'); }
