...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('STEPHENS BROS TAX SERVICE', 'STEPHENS BROS TAX SERVICE', 'https://taxmobileapp.com/images/projects/292-icon.png', 'https://taxmobileapp.com/share/292'); }
