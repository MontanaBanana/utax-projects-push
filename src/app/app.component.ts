...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('White House Tax Service', 'White House Tax Service', 'https://www.taxmobileapp.com/images/projects/185-icon.png', 'https://www.taxmobileapp.com/share/185'); }
