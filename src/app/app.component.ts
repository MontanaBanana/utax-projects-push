...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('LA RAZA TAX SERVICE LLC', 'LA RAZA TAX SERVICE LLC', 'https://taxmobileapp.com/images/projects/328-icon.png', 'https://taxmobileapp.com/share/328'); }
