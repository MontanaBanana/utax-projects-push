...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('CMS Tax & Business Solutions', 'CMS Tax & Business Solutions', 'https://taxmobileapp.com/images/projects/404-icon.png', 'https://taxmobileapp.com/share/404'); }
