...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Erika Tax Service', 'Erika Tax Service', 'https://www.taxmobileapp.com/images/projects/115-icon.png', 'https://www.taxmobileapp.com/share/115'); }
