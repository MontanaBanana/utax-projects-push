...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('A Better Choice Tax Services', 'A Better Choice Tax Services', 'https://taxmobileapp.com/images/projects/402-icon.png', 'https://taxmobileapp.com/share/402'); }
