...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Norm’s Elite Tax Service', 'Norm’s Elite Tax Service', 'https://www.taxmobileapp.com/images/projects/225-icon.png', 'https://www.taxmobileapp.com/share/225'); }
