...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Barron Income Tax', 'Barron Income Tax', 'https://taxmobileapp.com/images/projects/535-icon.png', 'https://taxmobileapp.com/share/535'); }
