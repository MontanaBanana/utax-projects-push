...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Voyager Tax Service', 'Voyager Tax Service', 'https://taxmobileapp.com/images/projects/319-icon.png', 'https://taxmobileapp.com/share/319'); }
