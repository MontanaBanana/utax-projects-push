...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('KB Professional Tax Service', 'KB Professional Tax Service', 'https://taxmobileapp.com/images/projects/487-icon.png', 'https://taxmobileapp.com/share/487'); }
