...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('MAXTAX SERVICES', 'MAXTAX SERVICES', 'https://taxmobileapp.com/images/projects/277-icon.png', 'https://taxmobileapp.com/share/277'); }
