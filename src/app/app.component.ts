...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Apple Valley Tax', 'Apple Valley Tax', 'https://www.taxmobileapp.com/images/projects/159-icon.png', 'https://www.taxmobileapp.com/share/159'); }
