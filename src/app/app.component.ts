...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Your Tax Doctor', 'Your Tax Doctor', 'https://taxmobileapp.com/images/projects/117-icon.png', 'https://taxmobileapp.com/share/117'); }
