...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('GREEN BACK TAX LLC', 'GREEN BACK TAX LLC', 'https://taxmobileapp.com/images/projects/323-icon.png', 'https://taxmobileapp.com/share/323'); }
