...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Bronx Tax LLC', 'Bronx Tax LLC', 'https://www.taxmobileapp.com/images/projects/40-icon.png', 'https://www.taxmobileapp.com/share/40'); }
