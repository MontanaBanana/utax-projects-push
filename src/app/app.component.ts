...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Family First Tax Services', 'Family First Tax Services', 'https://taxmobileapp.com/images/projects/245-icon.png', 'https://taxmobileapp.com/share/245'); }
