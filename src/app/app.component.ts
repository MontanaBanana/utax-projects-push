...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Tax Treasure Service', 'Tax Treasure Service', 'https://taxmobileapp.com/images/projects/290-icon.png', 'https://taxmobileapp.com/share/290'); }
