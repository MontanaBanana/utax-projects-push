...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Golden Stacks Tax Services', 'Golden Stacks Tax Services', 'https://taxmobileapp.com/images/projects/368-icon.png', 'https://taxmobileapp.com/share/368'); }
