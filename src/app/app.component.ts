...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('AAD Enterprises', 'AAD Enterprises', 'https://taxmobileapp.com/images/projects/464-icon.png', 'https://taxmobileapp.com/share/464'); }
