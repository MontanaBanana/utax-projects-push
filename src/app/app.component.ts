...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('FTP Tax Solutions - MAXTax', 'FTP Tax Solutions - MAXTax', 'https://www.taxmobileapp.com/images/projects/83-icon.png', 'https://www.taxmobileapp.com/share/83'); }
