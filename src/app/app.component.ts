...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Kingdom Tax Service', 'Kingdom Tax Service', 'https://www.taxmobileapp.com/images/projects/147-icon.png', 'https://www.taxmobileapp.com/share/147'); }
