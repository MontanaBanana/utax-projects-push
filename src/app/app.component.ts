...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Diversified Tax Service', 'Diversified Tax Service', 'https://taxmobileapp.com/images/projects/346-icon.png', 'https://taxmobileapp.com/share/346'); }
