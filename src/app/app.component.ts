...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Check Cashing USA', 'Check Cashing USA', 'https://www.taxmobileapp.com/images/projects/247-icon.png', 'https://www.taxmobileapp.com/share/247'); }
