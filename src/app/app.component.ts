...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('B & N Tax Services', 'B & N Tax Services', 'https://www.taxmobileapp.com/images/projects/220-icon.png', 'https://www.taxmobileapp.com/share/220'); }
