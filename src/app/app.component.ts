...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Saldana Tax and Bookkeeping Service', 'Saldana Tax and Bookkeeping Service', 'https://taxmobileapp.com/images/projects/318-icon.png', 'https://taxmobileapp.com/share/318'); }
