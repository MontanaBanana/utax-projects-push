...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Garner Tax Service', 'Garner Tax Service', 'https://taxmobileapp.com/images/projects/381-icon.png', 'https://taxmobileapp.com/share/381'); }
