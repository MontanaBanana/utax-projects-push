...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Royalty Finance Management', 'Royalty Finance Management', 'https://taxmobileapp.com/images/projects/334-icon.png', 'https://taxmobileapp.com/share/334'); }
