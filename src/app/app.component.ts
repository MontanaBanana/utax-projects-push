...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Madry Sister’s Mobile Tax Service', 'Madry Sister’s Mobile Tax Service', 'https://taxmobileapp.com/images/projects/397-icon.png', 'https://taxmobileapp.com/share/397'); }
