...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('U 1st Tax Service', 'U 1st Tax Service', 'https://taxmobileapp.com/images/projects/413-icon.png', 'https://taxmobileapp.com/share/413'); }
