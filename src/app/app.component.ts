...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('PTS Multiservices', 'PTS Multiservices', 'https://taxmobileapp.com/images/projects/458-icon.png', 'https://taxmobileapp.com/share/458'); }
