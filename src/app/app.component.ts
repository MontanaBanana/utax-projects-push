...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Diversified Business Consulting', 'Diversified Business Consulting', 'https://taxmobileapp.com/images/projects/429-icon.png', 'https://taxmobileapp.com/share/429'); }
