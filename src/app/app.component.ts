...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('NOVALINK TAX PLUS. INC.', 'NOVALINK TAX PLUS. INC.', 'https://taxmobileapp.com/images/projects/270-icon.png', 'https://taxmobileapp.com/share/270'); }
