...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Leticia R. Rodriguez', 'Leticia R. Rodriguez', 'https://www.taxmobileapp.com/images/projects/98-icon.png', 'https://www.taxmobileapp.com/share/98'); }
