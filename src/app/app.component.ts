...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Dream Team Consulting', 'Dream Team Consulting', 'https://www.taxmobileapp.com/images/projects/228-icon.png', 'https://www.taxmobileapp.com/share/228'); }
