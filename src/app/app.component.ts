...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('EOV Risk Management', 'EOV Risk Management', 'https://taxmobileapp.com/images/projects/375-icon.png', 'https://taxmobileapp.com/share/375'); }
