...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Paid in Full Tax Service', 'Paid in Full Tax Service', 'https://taxmobileapp.com/images/projects/536-icon.png', 'https://taxmobileapp.com/share/536'); }
