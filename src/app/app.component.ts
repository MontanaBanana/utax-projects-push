...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Service Income Tax & Travel Insurance', 'Service Income Tax & Travel Insurance', 'https://taxmobileapp.com/images/projects/302-icon.png', 'https://taxmobileapp.com/share/302'); }
