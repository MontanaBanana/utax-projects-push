...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Platinium Financial Inc', 'Platinium Financial Inc', 'https://taxmobileapp.com/images/projects/99-icon.png', 'https://taxmobileapp.com/share/99'); }
