...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Lighthouse Tax Solutions', 'Lighthouse Tax Solutions', 'https://taxmobileapp.com/images/projects/518-icon.png', 'https://taxmobileapp.com/share/518'); }
