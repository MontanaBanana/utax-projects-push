...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('PMATHIS and ASSOCIATES, LLC', 'PMATHIS and ASSOCIATES, LLC', 'https://taxmobileapp.com/images/projects/152-icon.png', 'https://taxmobileapp.com/share/152'); }
