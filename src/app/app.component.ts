...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Encino Income Tax Services', 'Encino Income Tax Services', 'https://taxmobileapp.com/images/projects/463-icon.png', 'https://taxmobileapp.com/share/463'); }
