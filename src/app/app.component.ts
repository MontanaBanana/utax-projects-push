...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Pryority Tax Solutions', 'Pryority Tax Solutions', 'https://taxmobileapp.com/images/projects/476-icon.png', 'https://taxmobileapp.com/share/476'); }
