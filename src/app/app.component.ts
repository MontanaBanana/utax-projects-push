...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('HUNT’S IMMIGRATION AND INCOME TAX', 'HUNT’S IMMIGRATION AND INCOME TAX', 'https://taxmobileapp.com/images/projects/505-icon.png', 'https://taxmobileapp.com/share/505'); }
