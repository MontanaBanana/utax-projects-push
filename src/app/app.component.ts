...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Community Tax Services', 'Community Tax Services', 'https://taxmobileapp.com/images/projects/356-icon.png', 'https://taxmobileapp.com/share/356'); }
