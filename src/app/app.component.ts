...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('TQ Financial Services, LLC', 'TQ Financial Services, LLC', 'https://taxmobileapp.com/images/projects/121-icon.png', 'https://taxmobileapp.com/share/121'); }
