...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('CONCEPTO LATINO', 'CONCEPTO LATINO', 'https://taxmobileapp.com/images/projects/538-icon.png', 'https://taxmobileapp.com/share/538'); }
