...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Monas Multiservice', 'Monas Multiservice', 'https://taxmobileapp.com/images/projects/491-icon.png', 'https://taxmobileapp.com/share/491'); }
