...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Digital Accounting & Tax Services, LLC', 'Digital Accounting & Tax Services, LLC', 'https://taxmobileapp.com/images/projects/262-icon.png', 'https://taxmobileapp.com/share/262'); }
