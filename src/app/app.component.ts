...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('ATO Hempstead', 'ATO Hempstead', 'https://www.taxmobileapp.com/images/projects/214-icon.png', 'https://www.taxmobileapp.com/share/214'); }
