...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Refund One Tax Group', 'Refund One Tax Group', 'https://taxmobileapp.com/images/projects/315-icon.png', 'https://taxmobileapp.com/share/315'); }
