...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('U.S. Taxes, LLC.', 'U.S. Taxes, LLC.', 'https://www.taxmobileapp.com/images/projects/261-icon.png', 'https://www.taxmobileapp.com/share/261'); }
