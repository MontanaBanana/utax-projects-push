...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Debbies Tax & Insurance', 'Debbies Tax & Insurance', 'https://taxmobileapp.com/images/projects/471-icon.png', 'https://taxmobileapp.com/share/471'); }
