...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('New Beginning Tax Service', 'New Beginning Tax Service', 'https://taxmobileapp.com/images/projects/403-icon.png', 'https://taxmobileapp.com/share/403'); }
