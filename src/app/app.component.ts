...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Pomona Tax Pros', 'Pomona Tax Pros', 'https://taxmobileapp.com/images/projects/149-icon.png', 'https://taxmobileapp.com/share/149'); }
