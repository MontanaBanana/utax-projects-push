...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Real Family Financial', 'Real Family Financial', 'https://taxmobileapp.com/images/projects/295-icon.png', 'https://taxmobileapp.com/share/295'); }
