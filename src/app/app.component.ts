...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Indy Income Tax Service', 'Indy Income Tax Service', 'https://www.taxmobileapp.com/images/projects/238-icon.png', 'https://www.taxmobileapp.com/share/238'); }
