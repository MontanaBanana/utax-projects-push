...
export class MyApp {
  ...
  openShare() { this.socialSharing.share('Affordable Tax & Accounting Services LLC', 'Affordable Tax & Accounting Services LLC', 'https://taxmobileapp.com/images/projects/344-icon.png', 'https://taxmobileapp.com/share/344'); }
