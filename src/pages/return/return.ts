...
@Component({
  ...
  templateUrl: 'https://taxmobileapp.com/apptemplate/return/279/version/1'
})
export class ReturnPage {
    ...
    public submitPhotos(): void {
        ...
        var p = this.http.post('https://taxmobileapp.com/zxing-commandline/barcode.php', {imgData: this.uploadbase64Image, project_id: 279}, options)
                .subscribe(
                    data => {
