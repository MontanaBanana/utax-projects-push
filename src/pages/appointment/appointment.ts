...
@Component({
  ...
  templateUrl: 'https://www.taxmobileapp.com/apptemplate/appointment/279'
})
export class AppointmentPage {
  ...
  constructor(public navCtrl: NavController, public http: Http, public sanitizer: DomSanitizer) {
	...
	var projects = this.http.get('https://www.taxmobileapp.com/account/project/appointment_url/279');
			projects
				.map(res => res.json())
				.subscribe(data => {
