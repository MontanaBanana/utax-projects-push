...
@Component({
  ...
  templateUrl: 'https://taxmobileapp.com/apptemplate/photos/546'
})
export class PhotosPage {
    ...
    public submitPhotos(img_name: string): void {
		...
		//console.log(options);
        var p = this.http.post('https://taxmobileapp.com/account/project/submitreturnimages', {imgData: this.uploadbase64Image, img_name: img_name, user_id: this.user_id, project_id: 546}, options)
				   .toPromise()
                   .then(
						data => {
							//this.presentSuccess();
